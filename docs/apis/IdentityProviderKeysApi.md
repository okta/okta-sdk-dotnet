...
> IdPKeyCredential ReplaceIdentityProviderKey (string kid, IdPKeyCredential idPKeyCredential)
...
namespace Example
{
    public class ReplaceIdentityProviderKeyExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new IdentityProviderKeysApi(config);
            var kid = KmMo85SSsU7TZzOShcGb;  // string | Unique `id` of the IdP key credential
            var idPKeyCredential = new IdPKeyCredential(); // IdPKeyCredential | Updated IdP key credential

...
**Asns** | **List&lt;string&gt;** | An array of ASNs for a Network Zone | [optional] 
**ProxyType** | **string** | The proxy type used for a Dynamic Network Zone | [optional] 
**Locations** | [**List&lt;NetworkZoneLocation&gt;**](NetworkZoneLocation.md) | An array of geolocations for a Dynamic Network Zone | [optional] 

# Okta.Sdk.Model.LogDebugContext
...
------------ | ------------- | ------------- | -------------
**DebugData** | **Dictionary&lt;string, Object&gt;** | A dynamic field that contains miscellaneous information that is dependent on the event type. | [optional] [readonly] 

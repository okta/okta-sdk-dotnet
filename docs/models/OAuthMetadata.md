...
**DpopSigningAlgValuesSupported** | **List&lt;OAuthMetadata.DpopSigningAlgValuesSupportedEnum&gt;** | A list of signing algorithms supported by this authorization server for Demonstrating Proof-of-Possession (DPoP) JWTs. | [optional] 

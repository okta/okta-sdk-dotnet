# Okta.Sdk.Model.TacAuthenticatorEnrollment
...
**Id** | **string** | A unique identifier of the authenticator enrollment | [optional] 
...
**Nickname** | **string** | A user-friendly name for the authenticator enrollment | [optional] 

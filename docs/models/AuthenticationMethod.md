...
**UserVerificationMethods** | **List&lt;AuthenticationMethod.UserVerificationMethodsEnum&gt;** | Indicates which methods can be used for user verification. &#x60;userVerificationMethods&#x60; can only be used when &#x60;userVerification&#x60; is &#x60;REQUIRED&#x60;. &#x60;BIOMETRICS&#x60; is currently the only supported method. | [optional] 

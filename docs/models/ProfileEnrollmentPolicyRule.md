# Okta.Sdk.Model.ProfileEnrollmentPolicyRule
...
**Status** | **LifecycleStatus** | Whether or not the rule is active. Use the &#x60;activate&#x60; query parameter to set the status of a rule. | [optional] 
...
**Conditions** | **string** | Policy rule conditions aren&#39;t supported for this policy type | [optional] 

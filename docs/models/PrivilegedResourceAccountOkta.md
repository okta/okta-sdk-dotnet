...
------------ | ------------- | ------------- | -------------
**ResourceType** | **PrivilegedResourceType** |  | 
**Created** | **DateTimeOffset** | Timestamp when the object was created | [optional] [readonly] 
**CredentialSyncInfo** | [**CredentialSyncInfo**](CredentialSyncInfo.md) |  | [optional] 
...
**ResourceId** | **string** | The user ID associated with the Okta privileged resource | [optional] 
**Credentials** | [**PrivilegedResourceCredentials**](PrivilegedResourceCredentials.md) |  | [optional] 
**Profile** | **Dictionary&lt;string, Object&gt;** | Specific profile properties for the privileged resource | [optional] [readonly] 

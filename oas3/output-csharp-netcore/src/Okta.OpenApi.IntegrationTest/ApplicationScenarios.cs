...
namespace Okta.Sdk.IntegrationTest
{
    public class ApplicationScenarios
    {
        ...
        public ApplicationScenarios()
        {
            ...
            _config.ApiKey.Add("Authorization", "{TOKEN}");
            _config.ApiKeyPrefix.Add("Authorization", "SSWS");
            _config.BasePath = "{OKTA_DOMAIN}";
        ...
        public async Task AddBookmarkApp()
        {
            ...
            try
            {
                var retrievedApp = await _applicationApi.GetApplicationAsync<BookmarkApplication>(createdApp.Id);
        ...
        public async Task AddBasicAuthenticationApp()
        {
            ...
            try
            {
                var retrieved = await _applicationApi.GetApplicationAsync<BasicAuthApplication>(createdApp.Id);
        ...
        public async Task AddOpenIdConnectApp()
        {
            ...
            try
            {
                var retrieved = await _applicationApi.GetApplicationAsync<OpenIdConnectApplication>(createdApp.Id);
        ...
        public async Task UpdateSWAApplicationAdminSetUsernameAndPassword()
        {
            ...
            try
            {
                var retrieved = await _applicationApi.GetApplicationAsync<SwaApplication>(createdApp.Id);
                ...
                retrieved = await _applicationApi.UpdateApplicationAsync<SwaApplication>(retrieved, retrieved.Id);
        ...
        public async Task UpdateApplicationProfile()
        {
            ...
            try
            {
                ...
                var persistedApp = await _applicationApi.GetApplicationAsync<OpenIdConnectApplication>(createdApp.Id);

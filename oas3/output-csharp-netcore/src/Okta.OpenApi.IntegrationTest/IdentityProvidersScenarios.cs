...
namespace Okta.OpenApi.IntegrationTest
{
    public class IdentityProvidersScenarios
    {
        ...
        public async Task GetListIdps()
        {
            ...
            try
            {
                var idps = await _idpApi.ListIdentityProvidersAsync();
        ...
        public async Task ListKeys()
        {
            ...
            try
            {
                var idpKeys = await _idpApi.ListIdentityProviderKeysAsync();
        ...
        public async Task ListSigningKeys()
        {
            ...
            try
            {
                ...
                var keys = await _idpApi.ListIdentityProviderSigningKeysAsync(createdIdp.Id);
        ...
        public async Task RevokeCsr()
        {
            ...
            try
            {
                ...
                var retrievedCsrs = await _idpApi.ListCsrsForIdentityProviderAsync(createdIdp.Id);
                ...
                retrievedCsrs = await _idpApi.ListCsrsForIdentityProviderAsync(createdIdp.Id);

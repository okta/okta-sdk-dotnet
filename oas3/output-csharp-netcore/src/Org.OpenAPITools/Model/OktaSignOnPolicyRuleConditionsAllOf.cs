...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OktaSignOnPolicyRuleConditions_allOf")]
    public partial class OktaSignOnPolicyRuleConditionsAllOf : IEquatable<OktaSignOnPolicyRuleConditionsAllOf>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OktaSignOnPolicyRuleConditionsAllOf {\n");
        ...
        {
            return this.Equals(input as OktaSignOnPolicyRuleConditionsAllOf);
        }

        /// <summary>
        /// Returns true if OktaSignOnPolicyRuleConditionsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OktaSignOnPolicyRuleConditionsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OktaSignOnPolicyRuleConditionsAllOf input)
        {
            if (input == null)
            {
                return false;

...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BouncesRemoveListObj : IEquatable<BouncesRemoveListObj>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as BouncesRemoveListObj);
        }

        /// <summary>
        /// Returns true if BouncesRemoveListObj instances are equal
        /// </summary>
        /// <param name="input">Instance of BouncesRemoveListObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BouncesRemoveListObj input)
        {
            if (input == null)
            {
                return false;

...
namespace Org.OpenAPITools.Model
{
    ...
    /// WebUserFactor
    /// </summary>
    [DataContract(Name = "WebUserFactor")]
    ...
    public partial class WebUserFactor : UserFactor, IEquatable<WebUserFactor>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as WebUserFactor);
        }

        /// <summary>
        /// Returns true if WebUserFactor instances are equal
        /// </summary>
        /// <param name="input">Instance of WebUserFactor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebUserFactor input)
        {
            if (input == null)
            {
                return false;

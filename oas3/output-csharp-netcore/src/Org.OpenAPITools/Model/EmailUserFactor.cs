...
namespace Org.OpenAPITools.Model
{
    ...
    /// EmailUserFactor
    /// </summary>
    [DataContract(Name = "EmailUserFactor")]
    ...
    public partial class EmailUserFactor : UserFactor, IEquatable<EmailUserFactor>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EmailUserFactor);
        }

        /// <summary>
        /// Returns true if EmailUserFactor instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailUserFactor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailUserFactor input)
        {
            if (input == null)
            {
                return false;

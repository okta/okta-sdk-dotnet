...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SecurePasswordStoreApplicationSettingsApplication : IEquatable<SecurePasswordStoreApplicationSettingsApplication>, IValidatableObject
    {

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PolicyRuleConditions")]
    public partial class PolicyRuleConditions : IEquatable<PolicyRuleConditions>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PolicyRuleConditions);
        }

        /// <summary>
        /// Returns true if PolicyRuleConditions instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyRuleConditions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyRuleConditions input)
        {
            if (input == null)
            {
                return false;

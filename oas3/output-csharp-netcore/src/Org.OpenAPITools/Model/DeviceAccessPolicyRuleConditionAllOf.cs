...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceAccessPolicyRuleCondition_allOf")]
    public partial class DeviceAccessPolicyRuleConditionAllOf : IEquatable<DeviceAccessPolicyRuleConditionAllOf>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DeviceAccessPolicyRuleConditionAllOf);
        }

        /// <summary>
        /// Returns true if DeviceAccessPolicyRuleConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceAccessPolicyRuleConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceAccessPolicyRuleConditionAllOf input)
        {
            if (input == null)
            {
                return false;

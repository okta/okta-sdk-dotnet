...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SecurityQuestionUserFactor")]
    ...
    public partial class SecurityQuestionUserFactor : UserFactor, IEquatable<SecurityQuestionUserFactor>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SecurityQuestionUserFactor);
        }

        /// <summary>
        /// Returns true if SecurityQuestionUserFactor instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityQuestionUserFactor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityQuestionUserFactor input)
        {
            if (input == null)
            {
                return false;

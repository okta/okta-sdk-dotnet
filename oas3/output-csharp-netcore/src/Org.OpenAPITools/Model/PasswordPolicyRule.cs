...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PasswordPolicyRule : PolicyRule, IEquatable<PasswordPolicyRule>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PasswordPolicyRule);
        }

        /// <summary>
        /// Returns true if PasswordPolicyRule instances are equal
        /// </summary>
        /// <param name="input">Instance of PasswordPolicyRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PasswordPolicyRule input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Client
{
    ...
    public interface IReadableConfiguration
    {
        ...
        /// <value>The value of the flag</value>
        bool? DisableHttpsCheck { get; }

        /// <summary>
        /// Gets the value of the DisableOktaDomainCheck flag.
        /// </summary>
        /// <value>The value of the flag</value>
        bool? DisableOktaDomainCheck { get; }
        ...
        /// <summary>
        /// Gets the private key. Required when AuthorizationMode is equal to PrivateKey, unless
        /// <see cref="PrivateKeySigningCredentials"/> is set.
        /// </summary>
        JsonWebKeyConfiguration PrivateKey { get; }

        /// <summary>
        /// Gets the credentials used to sign the client assertion JWT, for a private key held outside
        /// configuration such as in a TPM or a hardware security module. Takes precedence over
        /// <see cref="PrivateKey"/> when both are set.
        /// </summary>
        SigningCredentials PrivateKeySigningCredentials { get; }

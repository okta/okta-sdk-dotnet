// <copyright file="OrgPreferences.Generated.cs" company="Okta, Inc">
...
namespace Okta.Sdk
{
    ...
    public sealed partial class OrgPreferences : Resource, IOrgPreferences
    {
        ...
        /// <inheritdoc />
        public Task<IOrgPreferences> HideEndUserFooterAsync(
            CancellationToken cancellationToken = default(CancellationToken))
            => GetClient().Orgs.HideOktaUiFooterAsync(cancellationToken);
        
        /// <inheritdoc />
        public Task<IOrgPreferences> ShowEndUserFooterAsync(
            CancellationToken cancellationToken = default(CancellationToken))

...
additionalProperties:
  packageGuid: '{8A5CD353-2B21-4A52-9817-35C572357E83}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAgentPoolsApi>();
            IActivateAgentPoolsUpdateApiResponse apiResponse = await api.ActivateAgentPoolsUpdateAsync("todo");
            AgentPoolUpdate model = apiResponse.Ok();
        }
...
## Api Information
- appName: Okta Admin Management
- appVersion: 5.1.0
- appDescription: Allows customers to easily access the Okta Management APIs

...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IApplicationSSOApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<string> PreviewSAMLmetadataForApplicationAsync(  string appId ,   string kid , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Preview the application SAML metadata
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> PreviewSAMLmetadataForApplicationWithHttpInfoAsync(  string appId ,   string kid , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ApplicationSSOApi : IApplicationSSOApi
    {
        ...
        public ApplicationSSOApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> PreviewSAMLmetadataForApplicationAsync(  string appId ,   string kid , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<string> localVarResponse = await PreviewSAMLmetadataForApplicationWithHttpInfoAsync(appId, kid, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<string>> PreviewSAMLmetadataForApplicationWithHttpInfoAsync(  string appId ,   string kid , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (kid == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'kid' when calling ApplicationSSOApi->PreviewSAMLmetadataForApplication");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Okta.Sdk.Client.ClientUtils.ParameterToMultiMap("", "kid", kid));

...
namespace Okta.Sdk.Api
{
    ...
    /// </summary>
    public partial interface ITemplateApiAsync : IApiAccessor
    {
        ...
        IOktaCollectionClient<SmsTemplate> ListSmsTemplates(SmsTemplateType templateType  = null  , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all SMS templates
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<SmsTemplate>>> ListSmsTemplatesWithHttpInfoAsync(SmsTemplateType templateType  = null  , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SmsTemplate</returns>
        System.Threading.Tasks.Task<SmsTemplate> ReplaceSmsTemplateAsync(  string templateId ,   SmsTemplate smsTemplate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace an SMS template
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SmsTemplate)</returns>
        System.Threading.Tasks.Task<ApiResponse<SmsTemplate>> ReplaceSmsTemplateWithHttpInfoAsync(  string templateId ,   SmsTemplate smsTemplate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial interface ITemplateApi :  ITemplateApiAsync
    {
    ...
    public partial class TemplateApi : ITemplateApi
    {
        ...
        public TemplateApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<SmsTemplate>> CreateSmsTemplateWithHttpInfoAsync(  SmsTemplate smsTemplate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/templates/sms", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeleteSmsTemplateWithHttpInfoAsync(  string templateId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/templates/sms/{templateId}", "DELETE", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<SmsTemplate>> GetSmsTemplateWithHttpInfoAsync(  string templateId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/templates/sms/{templateId}", "GET", cancellationToken = default);
            }
        ...
        /// <returns>Task of List&lt;SmsTemplate&gt;</returns>
        //a
        public IOktaCollectionClient<SmsTemplate> ListSmsTemplates(SmsTemplateType templateType  = null  , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;SmsTemplate&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<SmsTemplate>>> ListSmsTemplatesWithHttpInfoAsync(SmsTemplateType templateType  = null  , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SmsTemplate</returns>
        public async System.Threading.Tasks.Task<SmsTemplate> ReplaceSmsTemplateAsync(  string templateId ,   SmsTemplate smsTemplate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<SmsTemplate> localVarResponse = await ReplaceSmsTemplateWithHttpInfoAsync(templateId, smsTemplate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// Replace an SMS template Replaces the SMS Template &gt; **Notes:** You can&#39;t update the default SMS Template. 
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SmsTemplate)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<SmsTemplate>> ReplaceSmsTemplateWithHttpInfoAsync(  string templateId ,   SmsTemplate smsTemplate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'templateId' when calling TemplateApi->ReplaceSmsTemplate");
            }

            // verify the required parameter 'smsTemplate' is set
            if (smsTemplate == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'smsTemplate' when calling TemplateApi->ReplaceSmsTemplate");
            }
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/templates/sms/{templateId}", "PUT", cancellationToken = default);
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ReplaceSmsTemplate", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <summary>
        /// Update an SMS template Updates only some of the SMS Template properties:   * All properties within the custom SMS Template that have values are updated.   * Any translation that doesn&#39;t exist is added.   * Any translation with a null or empty value is removed.   * Any translation with non-empty/null value is updated. 
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="templateId">&#x60;id&#x60; of the Template</param>
        /// <param name="smsTemplate"></param>
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<SmsTemplate>> UpdateSmsTemplateWithHttpInfoAsync(  string templateId ,   SmsTemplate smsTemplate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/templates/sms/{templateId}", "POST", cancellationToken = default);
            }

...
namespace Okta.Sdk.Api
{
    ...
    public partial class PushProviderApi : IPushProviderApi
    {
        ...
        public PushProviderApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PushProvider>> CreatePushProviderWithHttpInfoAsync(  PushProvider pushProvider , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/push-providers", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeletePushProviderWithHttpInfoAsync(  string pushProviderId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/push-providers/{pushProviderId}", "DELETE", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PushProvider>> GetPushProviderWithHttpInfoAsync(  string pushProviderId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/push-providers/{pushProviderId}", "GET", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PushProvider>> ReplacePushProviderWithHttpInfoAsync(  string pushProviderId ,   PushProvider pushProvider , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/push-providers/{pushProviderId}", "PUT", cancellationToken = default);
            }

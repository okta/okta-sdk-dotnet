...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IUserApiAsync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userIdOrLogin">User ID or login value of the user assigned the &#x60;associated&#x60; relationship</param>
        ...
        IOktaCollectionClient<Object> ListLinkedObjectsForUser(  string userIdOrLogin ,   string relationshipName ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List the primary or all of the associated Linked Object values
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Object>>> ListLinkedObjectsForUserWithHttpInfoAsync(  string userIdOrLogin ,   string relationshipName ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        ...
        IOktaCollectionClient<Group> ListUserGroups(  string userId ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all Groups
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Group>>> ListUserGroupsWithHttpInfoAsync(  string userId ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ReplaceLinkedObjectForUserAsync(  string userIdOrLogin ,   string primaryRelationshipName ,   string primaryUserId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace the Linked Object value for &#x60;primary&#x60;
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ReplaceLinkedObjectForUserWithHttpInfoAsync(  string userIdOrLogin ,   string primaryRelationshipName ,   string primaryUserId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a User
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">ID of an existing Okta user</param>
        /// <param name="removeRecoveryEnrollment">If &#x60;true&#x60;, removes the phone number as both a recovery method and a Factor. Supported Factors: &#x60;sms&#x60; and &#x60;call&#x60; (optional, default to false)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ResetFactorsAsync(  string userId ,   bool? removeRecoveryEnrollment = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Reset all Factors
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ResetFactorsWithHttpInfoAsync(  string userId ,   bool? removeRecoveryEnrollment = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
    ...
    public partial class UserApi : IUserApi
    {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<UserActivationToken>> ActivateUserWithHttpInfoAsync(  string userId ,   bool sendEmail , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/activate", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeactivateUserWithHttpInfoAsync(  string userId ,   bool? sendEmail = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/deactivate", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeleteLinkedObjectForUserWithHttpInfoAsync(  string userIdOrLogin ,   string relationshipName , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'userIdOrLogin' when calling UserApi->DeleteLinkedObjectForUser");
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeleteUserWithHttpInfoAsync(  string userId ,   bool? sendEmail = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}", "DELETE", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<User>> ExpirePasswordWithHttpInfoAsync(  string userId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/expire_password", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<TempPassword>> ExpirePasswordAndGetTemporaryPasswordWithHttpInfoAsync(  string userId ,   bool? revokeSessions = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/expire_password_with_temp_password", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<ResetPasswordToken>> GenerateResetPasswordTokenWithHttpInfoAsync(  string userId ,   bool sendEmail ,   bool? revokeSessions = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/reset_password", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<User>> GetUserWithHttpInfoAsync(  string userId ,   string expand = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}", "GET", cancellationToken = default);
            }
        ...
        /// <summary>
        /// List the primary or all of the associated Linked Object values Lists either the self link for the &#x60;primary&#x60; user or all &#x60;associated&#x60; users in the relationship specified by &#x60;relationshipName&#x60;. If the specified user isn&#39;t associated in any relationship, an empty array is returned.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userIdOrLogin">User ID or login value of the user assigned the &#x60;associated&#x60; relationship</param>
        /// <param name="relationshipName">Name of the &#x60;primary&#x60; or &#x60;associated&#x60; relationship being queried</param>
        ...
        /// <returns>Task of List&lt;Object&gt;</returns>
        //a
        public IOktaCollectionClient<Object> ListLinkedObjectsForUser(  string userIdOrLogin ,   string relationshipName ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userIdOrLogin' is set
            if (userIdOrLogin == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'userIdOrLogin' when calling UserApi->ListLinkedObjectsForUser");
            }
            ...
            return new OktaCollectionClient<Object>(localVarRequestOptions, "/api/v1/users/{userIdOrLogin}/linkedObjects/{relationshipName}", this.AsynchronousClient, this.Configuration, this._oAuthTokenProvider);
        }
        /// <summary>
        /// List the primary or all of the associated Linked Object values Lists either the self link for the &#x60;primary&#x60; user or all &#x60;associated&#x60; users in the relationship specified by &#x60;relationshipName&#x60;. If the specified user isn&#39;t associated in any relationship, an empty array is returned.
        /// </summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Object&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<Object>>> ListLinkedObjectsForUserWithHttpInfoAsync(  string userIdOrLogin ,   string relationshipName ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userIdOrLogin' is set
            if (userIdOrLogin == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Object>>("/api/v1/users/{userIdOrLogin}/linkedObjects/{relationshipName}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Task of List&lt;Group&gt;</returns>
        //a
        public IOktaCollectionClient<Group> ListUserGroups(  string userId ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Group&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<Group>>> ListUserGroupsWithHttpInfoAsync(  string userId ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
        ...
        /// <summary>
        /// Reactivate a User Reactivates a user. This operation can only be performed on users with a &#x60;PROVISIONED&#x60; status.  This operation restarts the activation workflow if the user activation wasn&#39;t completed with the &#x60;activationToken&#x60; from [Activate a user](/openapi/okta-management/management/tag/User/#tag/User/operation/activateUser).  &gt; **Note:** A successful request to this endpoint records the same set of events as when a user is activated in System Logs, since it invokes the same activation workflow.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">ID of an existing Okta user</param>
        /// <param name="sendEmail">Sends an activation email to the user if true (optional, default to false)</param>
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<UserActivationToken>> ReactivateUserWithHttpInfoAsync(  string userId ,   bool? sendEmail = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/reactivate", "POST", cancellationToken = default);
            }
        ...
        /// <summary>
        /// Replace the Linked Object value for &#x60;primary&#x60; Replaces the first user as the &#x60;associated&#x60; and the second user as the &#x60;primary&#x60; for the specified relationship. If the first user is already associated with a different &#x60;primary&#x60; for this relationship, replaces the previous link. A Linked Object relationship can specify only one &#x60;primary&#x60; user for an &#x60;associated&#x60; user.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userIdOrLogin">User ID or login value of the user assigned the &#x60;associated&#x60; relationship</param>
        /// <param name="primaryRelationshipName">Name of the &#x60;primary&#x60; relationship being assigned</param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ReplaceLinkedObjectForUserAsync(  string userIdOrLogin ,   string primaryRelationshipName ,   string primaryUserId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ReplaceLinkedObjectForUserWithHttpInfoAsync(userIdOrLogin, primaryRelationshipName, primaryUserId, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Replace the Linked Object value for &#x60;primary&#x60; Replaces the first user as the &#x60;associated&#x60; and the second user as the &#x60;primary&#x60; for the specified relationship. If the first user is already associated with a different &#x60;primary&#x60; for this relationship, replaces the previous link. A Linked Object relationship can specify only one &#x60;primary&#x60; user for an &#x60;associated&#x60; user.
        /// </summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> ReplaceLinkedObjectForUserWithHttpInfoAsync(  string userIdOrLogin ,   string primaryRelationshipName ,   string primaryUserId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userIdOrLogin' is set
            if (userIdOrLogin == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'userIdOrLogin' when calling UserApi->ReplaceLinkedObjectForUser");
            }

            // verify the required parameter 'primaryRelationshipName' is set
            if (primaryRelationshipName == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'primaryRelationshipName' when calling UserApi->ReplaceLinkedObjectForUser");
            }

            // verify the required parameter 'primaryUserId' is set
            if (primaryUserId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'primaryUserId' when calling UserApi->ReplaceLinkedObjectForUser");
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ReplaceLinkedObjectForUser", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<User>> ReplaceUserWithHttpInfoAsync(  string userId ,   User user ,   bool? strict = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}", "PUT", cancellationToken = default);
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ResetFactorsAsync(  string userId ,   bool? removeRecoveryEnrollment = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ResetFactorsWithHttpInfoAsync(userId, removeRecoveryEnrollment, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Reset all Factors Resets all factors for the specified user. All MFA factor enrollments returned to the unenrolled state. The user&#39;s status remains ACTIVE. This link is present only if the user is currently enrolled in one or more MFA factors.
        /// </summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> ResetFactorsWithHttpInfoAsync(  string userId ,   bool? removeRecoveryEnrollment = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/reset_factors", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> SuspendUserWithHttpInfoAsync(  string userId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/suspend", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> UnlockUserWithHttpInfoAsync(  string userId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/unlock", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> UnsuspendUserWithHttpInfoAsync(  string userId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}/lifecycle/unsuspend", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<User>> UpdateUserWithHttpInfoAsync(  string userId ,   UpdateUserRequest user ,   bool? strict = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/users/{userId}", "POST", cancellationToken = default);
            }

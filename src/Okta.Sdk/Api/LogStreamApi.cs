...
namespace Okta.Sdk.Api
{
    ...
    public partial interface ILogStreamApiAsync : IApiAccessor
    {
        ...
        /// <param name="logStreamId">id of the log stream</param>
        ...
        /// <param name="filter">SCIM filter expression that filters the results. This expression only supports the &#x60;eq&#x60; operator on either the &#x60;status&#x60; or &#x60;type&#x60;. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LogStream</returns>
        System.Threading.Tasks.Task<LogStream> ReplaceLogStreamAsync(  string logStreamId ,   LogStream instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a Log Stream
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LogStream)</returns>
        System.Threading.Tasks.Task<ApiResponse<LogStream>> ReplaceLogStreamWithHttpInfoAsync(  string logStreamId ,   LogStream instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class LogStreamApi : ILogStreamApi
    {
        ...
        /// <summary>
        /// Retrieve a Log Stream Retrieve a log stream by &#x60;logStreamId&#x60;
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logStreamId">id of the log stream</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <summary>
        /// List all Log Streams Lists all log streams. You can request a paginated list or a subset of Log Streams that match a supported filter expression.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="after">The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](/#pagination) for more information. (optional)</param>
        /// <param name="limit">A limit on the number of objects to return. (optional, default to 20)</param>
        ...
        /// <summary>
        /// Replace a Log Stream Replaces a log stream by &#x60;logStreamId&#x60;
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logStreamId">id of the log stream</param>
        /// <param name="instance"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LogStream</returns>
        public async System.Threading.Tasks.Task<LogStream> ReplaceLogStreamAsync(  string logStreamId ,   LogStream instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LogStream)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<LogStream>> ReplaceLogStreamWithHttpInfoAsync(  string logStreamId ,   LogStream instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'logStreamId' is set
            if (logStreamId == null)
            {

...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IDeviceApiAsync : IApiAccessor
    {
        ...
        /// <param name="expand">Lists associated users for the device in &#x60;_embedded&#x60; element (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Device&gt;</returns>
        IOktaCollectionClient<Device> ListDevices(  string after = default(string) ,   int? limit = default(int?) ,   string search = default(string) ,   string expand = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all Devices
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Device>>> ListDevicesWithHttpInfoAsync(  string after = default(string) ,   int? limit = default(int?) ,   string search = default(string) ,   string expand = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Suspend a Device
        /// </summary>
        /// <remarks>
    ...
    public partial class DeviceApi : IDeviceApi
    {
        ...
        /// <returns>Task of List&lt;Device&gt;</returns>
        //a
        public IOktaCollectionClient<Device> ListDevices(  string after = default(string) ,   int? limit = default(int?) ,   string search = default(string) ,   string expand = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Device&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<Device>>> ListDevicesWithHttpInfoAsync(  string after = default(string) ,   int? limit = default(int?) ,   string search = default(string) ,   string expand = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

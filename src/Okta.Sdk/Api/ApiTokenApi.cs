...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IApiTokenApiAsync : IApiAccessor
    {
        ...
        IOktaCollectionClient<ApiToken> ListApiTokens(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all API Token Metadata
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ApiToken>>> ListApiTokensWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Revoke an API Token
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="apiTokenId">id of the API Token</param>
        /// <param name="apiTokenUpdate"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiToken</returns>
        System.Threading.Tasks.Task<ApiToken> UpsertApiTokenAsync(  string apiTokenId ,   ApiTokenUpdate apiTokenUpdate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Upsert an API Token Network Condition
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiToken)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiToken>> UpsertApiTokenWithHttpInfoAsync(  string apiTokenId ,   ApiTokenUpdate apiTokenUpdate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ApiTokenApi : IApiTokenApi
    {
        ...
        public ApiTokenApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<ApiToken>> GetApiTokenWithHttpInfoAsync(  string apiTokenId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/api-tokens/{apiTokenId}", "GET", cancellationToken = default);
            }
        ...
        /// <returns>Task of List&lt;ApiToken&gt;</returns>
        //a
        public IOktaCollectionClient<ApiToken> ListApiTokens(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ApiToken&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<ApiToken>>> ListApiTokensWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> RevokeApiTokenWithHttpInfoAsync(  string apiTokenId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/api-tokens/{apiTokenId}", "DELETE", cancellationToken = default);
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiToken</returns>
        public async System.Threading.Tasks.Task<ApiToken> UpsertApiTokenAsync(  string apiTokenId ,   ApiTokenUpdate apiTokenUpdate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<ApiToken> localVarResponse = await UpsertApiTokenWithHttpInfoAsync(apiTokenId, apiTokenUpdate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// Upsert an API Token Network Condition Upserts an API Token Network Condition by &#x60;apiTokenId&#x60;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiToken)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<ApiToken>> UpsertApiTokenWithHttpInfoAsync(  string apiTokenId ,   ApiTokenUpdate apiTokenUpdate , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'apiTokenId' is set
            if (apiTokenId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'apiTokenId' when calling ApiTokenApi->UpsertApiToken");
            }

            // verify the required parameter 'apiTokenUpdate' is set
            if (apiTokenUpdate == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'apiTokenUpdate' when calling ApiTokenApi->UpsertApiToken");
            }
            ...
            localVarRequestOptions.PathParameters.Add("apiTokenId", Okta.Sdk.Client.ClientUtils.ParameterToString(apiTokenId)); // path parameter
            localVarRequestOptions.Data = apiTokenUpdate;
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/api-tokens/{apiTokenId}", "PUT", cancellationToken = default);
            }

            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ApiToken>("/api/v1/api-tokens/{apiTokenId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("UpsertApiToken", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

...
namespace Okta.Sdk.Api
{
    ...
    public partial interface ILinkedObjectApiAsync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="linkedObjectName">Primary or Associated name</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    ...
    public partial class LinkedObjectApi : ILinkedObjectApi
    {
        ...
        public LinkedObjectApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<LinkedObject>> CreateLinkedObjectDefinitionWithHttpInfoAsync(  LinkedObject linkedObject , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/meta/schemas/user/linkedObjects", "POST", cancellationToken = default);
            }
        ...
        /// <summary>
        /// Delete a linked object definition Deletes the Linked Object definition specified by either the &#x60;primary&#x60; or &#x60;associated&#x60; name. The entire definition is removed, regardless of which name that you specify.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="linkedObjectName">Primary or Associated name</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeleteLinkedObjectDefinitionWithHttpInfoAsync(  string linkedObjectName , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/meta/schemas/user/linkedObjects/{linkedObjectName}", "DELETE", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<LinkedObject>> GetLinkedObjectDefinitionWithHttpInfoAsync(  string linkedObjectName , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/meta/schemas/user/linkedObjects/{linkedObjectName}", "GET", cancellationToken = default);
            }

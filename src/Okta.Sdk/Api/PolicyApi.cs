...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IPolicyApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PolicyRule> CreatePolicyRuleAsync(  string policyId ,   PolicyRule policyRule ,   bool? activate = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a Policy Rule
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<PolicyRule>> CreatePolicyRuleWithHttpInfoAsync(  string policyId ,   PolicyRule policyRule ,   bool? activate = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        ...
        /// <param name="expand">Use &#x60;expand&#x3D;EVALUATED&#x60; to include a list of evaluated but not matched policies and policy rules. Use &#x60;expand&#x3D;RULE&#x60; to include details about why a rule condition was (not) matched. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        IOktaCollectionClient<Policy> ListPolicies(PolicyType type  ,   string status = default(string) ,   string expand = default(string) ,   string sortBy = default(string) ,   string limit = default(string) ,   string after = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all Policies
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Policy>>> ListPoliciesWithHttpInfoAsync(PolicyType type  ,   string status = default(string) ,   string expand = default(string) ,   string sortBy = default(string) ,   string limit = default(string) ,   string after = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
    ...
    public partial class PolicyApi : IPolicyApi
    {
        ...
        /// <summary>
        /// Create a Policy Rule Creates a policy rule. **Note:** You can&#39;t create additional rules for the &#x60;PROFILE_ENROLLMENT&#x60; or &#x60;CONTINUOUS_ACCESS&#x60; policies.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="policyId">&#x60;id&#x60; of the Policy</param>
        /// <param name="policyRule"></param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PolicyRule</returns>
        public async System.Threading.Tasks.Task<PolicyRule> CreatePolicyRuleAsync(  string policyId ,   PolicyRule policyRule ,   bool? activate = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<PolicyRule> localVarResponse = await CreatePolicyRuleWithHttpInfoAsync(policyId, policyRule, activate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// Create a Policy Rule Creates a policy rule. **Note:** You can&#39;t create additional rules for the &#x60;PROFILE_ENROLLMENT&#x60; or &#x60;CONTINUOUS_ACCESS&#x60; policies.
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PolicyRule)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PolicyRule>> CreatePolicyRuleWithHttpInfoAsync(  string policyId ,   PolicyRule policyRule ,   bool? activate = default(bool?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'policyId' is set
            if (policyId == null)
            {
        ...
        /// <returns>Task of List&lt;Policy&gt;</returns>
        //a
        public IOktaCollectionClient<Policy> ListPolicies(PolicyType type  ,   string status = default(string) ,   string expand = default(string) ,   string sortBy = default(string) ,   string limit = default(string) ,   string after = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Policy&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<Policy>>> ListPoliciesWithHttpInfoAsync(PolicyType type  ,   string status = default(string) ,   string expand = default(string) ,   string sortBy = default(string) ,   string limit = default(string) ,   string after = default(string) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {

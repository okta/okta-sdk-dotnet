...
namespace Okta.Sdk.Api
{
    ...
    public partial class SubscriptionApi : ISubscriptionApi
    {
        ...
        /// <returns></returns>
        public SubscriptionApi(Okta.Sdk.Client.Configuration configuration = null, IOAuthTokenProvider oAuthTokenProvider = null)
        {
        ...
        public IOktaCollectionClient<Subscription> ListRoleSubscriptions(string roleTypeOrRoleId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            return new OktaCollectionClient<Subscription>(localVarRequestOptions, "/api/v1/roles/{roleTypeOrRoleId}/subscriptions", this.AsynchronousClient, this.Configuration, this._oAuthTokenProvider);
        }
        /// <summary>
        /// List all Subscriptions of a Custom Role When roleType List all subscriptions of a Role. Else when roleId List subscriptions of a Custom Role
        /// </summary>

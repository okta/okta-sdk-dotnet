...
namespace Okta.Sdk.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISessionApi :  ISessionApiAsync
    {
    ...
    public partial class SessionApi : ISessionApi
    {
        ...
        /// <returns></returns>
        public SessionApi(Okta.Sdk.Client.Configuration configuration = null, IOAuthTokenProvider oAuthTokenProvider = null)
        {

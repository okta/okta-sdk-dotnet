...
namespace Okta.Sdk.Api
{
    ...
    /// </summary>
    public partial interface IEmailCustomizationApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial interface IEmailCustomizationApi :  IEmailCustomizationApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class EmailCustomizationApi : IEmailCustomizationApi
    {
        ...
        public EmailCustomizationApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        /// <returns></returns>
        public EmailCustomizationApi(Okta.Sdk.Client.Configuration configuration = null, IOAuthTokenProvider oAuthTokenProvider = null, WebProxy webProxy = null)
        {
        ...
        public EmailCustomizationApi(Okta.Sdk.Client.IAsynchronousClient asyncClient, Okta.Sdk.Client.IReadableConfiguration configuration)
        {

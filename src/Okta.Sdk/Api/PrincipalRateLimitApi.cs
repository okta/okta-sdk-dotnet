...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IPrincipalRateLimitApiAsync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filter">Filters the list of principal rate limit entities by the provided principal type (&#x60;principalType&#x60;). For example, &#x60;filter&#x3D;principalType eq \&quot;SSWS_TOKEN\&quot;&#x60; or &#x60;filter&#x3D;principalType eq \&quot;OAUTH_CLIENT\&quot;&#x60;.</param>
        /// <param name="after">The cursor to use for pagination. It&#39;s an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination). (optional)</param>
        /// <param name="limit">Specifies the number of items to return in a single response page. (optional, default to 20)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;PrincipalRateLimitEntity&gt;</returns>
        IOktaCollectionClient<PrincipalRateLimitEntity> ListPrincipalRateLimitEntities(  string filter ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all principal rate limits
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<PrincipalRateLimitEntity>>> ListPrincipalRateLimitEntitiesWithHttpInfoAsync(  string filter ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PrincipalRateLimitEntity</returns>
        System.Threading.Tasks.Task<PrincipalRateLimitEntity> ReplacePrincipalRateLimitEntityAsync(  string principalRateLimitId ,   PrincipalRateLimitEntity entity , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a principal rate limit
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PrincipalRateLimitEntity)</returns>
        System.Threading.Tasks.Task<ApiResponse<PrincipalRateLimitEntity>> ReplacePrincipalRateLimitEntityWithHttpInfoAsync(  string principalRateLimitId ,   PrincipalRateLimitEntity entity , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PrincipalRateLimitApi : IPrincipalRateLimitApi
    {
        ...
        public PrincipalRateLimitApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        /// <summary>
        /// Create a principal rate limit Creates a new principal rate limit entity. Okta only allows one principal rate limit entity per org and principal.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="entity"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PrincipalRateLimitEntity>> CreatePrincipalRateLimitEntityWithHttpInfoAsync(  PrincipalRateLimitEntity entity , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/principal-rate-limits", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PrincipalRateLimitEntity>> GetPrincipalRateLimitEntityWithHttpInfoAsync(  string principalRateLimitId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/principal-rate-limits/{principalRateLimitId}", "GET", cancellationToken = default);
            }
        ...
        /// <returns>Task of List&lt;PrincipalRateLimitEntity&gt;</returns>
        //a
        public IOktaCollectionClient<PrincipalRateLimitEntity> ListPrincipalRateLimitEntities(  string filter ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'filter' is set
            if (filter == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'filter' when calling PrincipalRateLimitApi->ListPrincipalRateLimitEntities");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;PrincipalRateLimitEntity&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<PrincipalRateLimitEntity>>> ListPrincipalRateLimitEntitiesWithHttpInfoAsync(  string filter ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'filter' is set
            if (filter == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PrincipalRateLimitEntity</returns>
        public async System.Threading.Tasks.Task<PrincipalRateLimitEntity> ReplacePrincipalRateLimitEntityAsync(  string principalRateLimitId ,   PrincipalRateLimitEntity entity , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<PrincipalRateLimitEntity> localVarResponse = await ReplacePrincipalRateLimitEntityWithHttpInfoAsync(principalRateLimitId, entity, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// Replace a principal rate limit Replaces a principal rate limit entity by &#x60;principalRateLimitId&#x60;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PrincipalRateLimitEntity)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<PrincipalRateLimitEntity>> ReplacePrincipalRateLimitEntityWithHttpInfoAsync(  string principalRateLimitId ,   PrincipalRateLimitEntity entity , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'principalRateLimitId' is set
            if (principalRateLimitId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'principalRateLimitId' when calling PrincipalRateLimitApi->ReplacePrincipalRateLimitEntity");
            }

            // verify the required parameter 'entity' is set
            if (entity == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'entity' when calling PrincipalRateLimitApi->ReplacePrincipalRateLimitEntity");
            }
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/principal-rate-limits/{principalRateLimitId}", "PUT", cancellationToken = default);
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ReplacePrincipalRateLimitEntity", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

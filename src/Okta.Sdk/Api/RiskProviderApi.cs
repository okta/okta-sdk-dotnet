...
namespace Okta.Sdk.Api
{
    ...
    /// </summary>
    public interface IRiskProviderApiAsync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="riskProviderId">&#x60;id&#x60; of the risk provider</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RiskProvider</returns>
        System.Threading.Tasks.Task<RiskProvider> UpdateRiskProviderAsync(  string riskProviderId ,   RiskProvider instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a Risk Provider
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RiskProvider)</returns>
        System.Threading.Tasks.Task<ApiResponse<RiskProvider>> UpdateRiskProviderWithHttpInfoAsync(  string riskProviderId ,   RiskProvider instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRiskProviderApi :  IRiskProviderApiAsync
    {
    ...
    public partial class RiskProviderApi : IRiskProviderApi
    {
        ...
        /// <summary>
        /// Delete a Risk Provider Delete a CAPTCHA instance by &#x60;riskProviderId&#x60;.
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="riskProviderId">&#x60;id&#x60; of the risk provider</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RiskProvider</returns>
        public async System.Threading.Tasks.Task<RiskProvider> UpdateRiskProviderAsync(  string riskProviderId ,   RiskProvider instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<RiskProvider> localVarResponse = await UpdateRiskProviderWithHttpInfoAsync(riskProviderId, instance, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// Replace a Risk Provider Replaces a risk provider by &#x60;riskProviderId&#x60;.
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RiskProvider)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<RiskProvider>> UpdateRiskProviderWithHttpInfoAsync(  string riskProviderId ,   RiskProvider instance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'riskProviderId' is set
            if (riskProviderId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'riskProviderId' when calling RiskProviderApi->UpdateRiskProvider");
            }

            // verify the required parameter 'instance' is set
            if (instance == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'instance' when calling RiskProviderApi->UpdateRiskProvider");
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("UpdateRiskProvider", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

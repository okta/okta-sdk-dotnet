...
namespace Okta.Sdk.Api
{
    ...
    /// </summary>
    public partial interface IDeviceAssuranceApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeviceAssurance</returns>
        System.Threading.Tasks.Task<DeviceAssurance> ReplaceDeviceAssurancePolicyAsync(  string deviceAssuranceId ,   DeviceAssurance deviceAssurance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a device assurance policy
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeviceAssurance)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeviceAssurance>> ReplaceDeviceAssurancePolicyWithHttpInfoAsync(  string deviceAssuranceId ,   DeviceAssurance deviceAssurance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial interface IDeviceAssuranceApi :  IDeviceAssuranceApiAsync
    {
    ...
    public partial class DeviceAssuranceApi : IDeviceAssuranceApi
    {
        ...
        public DeviceAssuranceApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<DeviceAssurance>> CreateDeviceAssurancePolicyWithHttpInfoAsync(  DeviceAssurance deviceAssurance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/device-assurances", "POST", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeleteDeviceAssurancePolicyWithHttpInfoAsync(  string deviceAssuranceId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/device-assurances/{deviceAssuranceId}", "DELETE", cancellationToken = default);
            }
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<DeviceAssurance>> GetDeviceAssurancePolicyWithHttpInfoAsync(  string deviceAssuranceId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/device-assurances/{deviceAssuranceId}", "GET", cancellationToken = default);
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeviceAssurance</returns>
        public async System.Threading.Tasks.Task<DeviceAssurance> ReplaceDeviceAssurancePolicyAsync(  string deviceAssuranceId ,   DeviceAssurance deviceAssurance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<DeviceAssurance> localVarResponse = await ReplaceDeviceAssurancePolicyWithHttpInfoAsync(deviceAssuranceId, deviceAssurance, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// Replace a device assurance policy Replaces a device assurance policy by &#x60;deviceAssuranceId&#x60;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeviceAssurance)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<DeviceAssurance>> ReplaceDeviceAssurancePolicyWithHttpInfoAsync(  string deviceAssuranceId ,   DeviceAssurance deviceAssurance , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'deviceAssuranceId' is set
            if (deviceAssuranceId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'deviceAssuranceId' when calling DeviceAssuranceApi->ReplaceDeviceAssurancePolicy");
            }

            // verify the required parameter 'deviceAssurance' is set
            if (deviceAssurance == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'deviceAssurance' when calling DeviceAssuranceApi->ReplaceDeviceAssurancePolicy");
            }
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/api/v1/device-assurances/{deviceAssuranceId}", "PUT", cancellationToken = default);
            }
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ReplaceDeviceAssurancePolicy", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

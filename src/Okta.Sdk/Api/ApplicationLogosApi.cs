...
namespace Okta.Sdk.Api
{
    ...
    public partial class ApplicationLogosApi : IApplicationLogosApi
    {
        ...
        public ApplicationLogosApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {

...
namespace Okta.Sdk.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUserFactorApi :  IUserFactorApiAsync
    {
    ...
    public partial class UserFactorApi : IUserFactorApi
    {
        ...
        /// <returns></returns>
        public UserFactorApi(Okta.Sdk.Client.Configuration configuration = null, IOAuthTokenProvider oAuthTokenProvider = null)
        {

...
namespace Okta.Sdk.Api
{
    ...
    public partial interface IGroupApiAsync : IApiAccessor
    {
        ...
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="groupId">The &#x60;id&#x60; of the group</param>
        /// <param name="search">Searches for users with a supported filtering expression for user name, primary email, or user name (optional)</param>
        /// <param name="sortBy">Specifies which field to sort by. This can be any single property. (optional)</param>
        /// <param name="sortOrder">Specifies sort order: &#x60;asc&#x60; or &#x60;desc&#x60;. This parameter is ignored if &#x60;sortBy&#x60; is not present. Users with the same value for the &#x60;sortBy&#x60; parameter are ordered by &#x60;id&#x60;. (optional, default to &quot;asc&quot;)</param>
        ...
        IOktaCollectionClient<GroupMember> ListGroupUsers(  string groupId ,   string search = default(string) ,   string sortBy = default(string) ,   string sortOrder = default(string) ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all Member Users
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<GroupMember>>> ListGroupUsersWithHttpInfoAsync(  string groupId ,   string search = default(string) ,   string sortBy = default(string) ,   string sortOrder = default(string) ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all Groups
        /// </summary>
        /// <remarks>
    ...
    public partial class GroupApi : IGroupApi
    {
        ...
        /// <returns>Task of List&lt;GroupMember&gt;</returns>
        //a
        public IOktaCollectionClient<GroupMember> ListGroupUsers(  string groupId ,   string search = default(string) ,   string sortBy = default(string) ,   string sortOrder = default(string) ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'groupId' is set
            if (groupId == null)
            {
            ...
            return new OktaCollectionClient<GroupMember>(localVarRequestOptions, "/api/v1/groups/{groupId}/users", this.AsynchronousClient, this.Configuration, this._oAuthTokenProvider);
        }
        /// <summary>
        /// List all Member Users Lists all users that are a member of a group
        /// </summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;GroupMember&gt;)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<List<GroupMember>>> ListGroupUsersWithHttpInfoAsync(  string groupId ,   string search = default(string) ,   string sortBy = default(string) ,   string sortOrder = default(string) ,   string after = default(string) ,   int? limit = default(int?) , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'groupId' is set
            if (groupId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<GroupMember>>("/api/v1/groups/{groupId}/users", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

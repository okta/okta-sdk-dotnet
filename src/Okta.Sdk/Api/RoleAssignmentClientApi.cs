...
namespace Okta.Sdk.Api
{
    ...
    /// </summary>
    public partial interface IRoleAssignmentClientApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteRoleFromClientAsync(  string clientId ,   string roleAssignmentId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Unassign a client role
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteRoleFromClientWithHttpInfoAsync(  string clientId ,   string roleAssignmentId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListGroupAssignedRoles200ResponseInner</returns>
        System.Threading.Tasks.Task<ListGroupAssignedRoles200ResponseInner> ListRolesForClientAsync(  string clientId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all client role assignments
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListGroupAssignedRoles200ResponseInner)</returns>
        System.Threading.Tasks.Task<ApiResponse<ListGroupAssignedRoles200ResponseInner>> ListRolesForClientWithHttpInfoAsync(  string clientId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial interface IRoleAssignmentClientApi :  IRoleAssignmentClientApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RoleAssignmentClientApi : IRoleAssignmentClientApi
    {
        private Okta.Sdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        private IOAuthTokenProvider _oAuthTokenProvider;
        
        public RoleAssignmentClientApi(Okta.Sdk.Client.OktaApiClientOptions options) : this(options.Configuration, options.OAuthTokenProvider, options.WebProxy)
        {
            this.AsynchronousClient = new Okta.Sdk.Client.ApiClient(options);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RoleAssignmentClientApi"/> class
        ...
        /// <returns></returns>
        public RoleAssignmentClientApi(Okta.Sdk.Client.Configuration configuration = null, IOAuthTokenProvider oAuthTokenProvider = null, WebProxy webProxy = null)
        {
        ...
        public RoleAssignmentClientApi(Okta.Sdk.Client.IAsynchronousClient asyncClient, Okta.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<ListGroupAssignedRoles200ResponseInner>> AssignRoleToClientWithHttpInfoAsync(  string clientId ,   AssignRoleToGroupRequest assignRoleToGroupRequest , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (clientId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'clientId' when calling RoleAssignmentClientApi->AssignRoleToClient");
            }

            // verify the required parameter 'assignRoleToGroupRequest' is set
            if (assignRoleToGroupRequest == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'assignRoleToGroupRequest' when calling RoleAssignmentClientApi->AssignRoleToClient");
            }
            ...
            localVarRequestOptions.Data = assignRoleToGroupRequest;
        ...
        /// <summary>
        /// Unassign a client role Unassigns a role assignment (identified by &#x60;roleAssignmentId&#x60;) from a client app (identified by &#x60;clientId&#x60;)
        /// </summary>
        /// <exception cref="Okta.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="clientId">Client app ID</param>
        /// <param name="roleAssignmentId">The &#x60;id&#x60; of the role assignment</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteRoleFromClientAsync(  string clientId ,   string roleAssignmentId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteRoleFromClientWithHttpInfoAsync(clientId, roleAssignmentId, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Unassign a client role Unassigns a role assignment (identified by &#x60;roleAssignmentId&#x60;) from a client app (identified by &#x60;clientId&#x60;)
        /// </summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<Object>> DeleteRoleFromClientWithHttpInfoAsync(  string clientId ,   string roleAssignmentId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'clientId' is set
            if (clientId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'clientId' when calling RoleAssignmentClientApi->DeleteRoleFromClient");
            }

            // verify the required parameter 'roleAssignmentId' is set
            if (roleAssignmentId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'roleAssignmentId' when calling RoleAssignmentClientApi->DeleteRoleFromClient");
            }
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/oauth2/v1/clients/{clientId}/roles/{roleAssignmentId}", "DELETE", cancellationToken = default);
            }

            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/oauth2/v1/clients/{clientId}/roles/{roleAssignmentId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListGroupAssignedRoles200ResponseInner</returns>
        public async System.Threading.Tasks.Task<ListGroupAssignedRoles200ResponseInner> ListRolesForClientAsync(  string clientId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Okta.Sdk.Client.ApiResponse<ListGroupAssignedRoles200ResponseInner> localVarResponse = await ListRolesForClientWithHttpInfoAsync(clientId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        /// List all client role assignments Lists all roles assigned to a client app identified by &#x60;clientId&#x60;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListGroupAssignedRoles200ResponseInner)</returns>
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<ListGroupAssignedRoles200ResponseInner>> ListRolesForClientWithHttpInfoAsync(  string clientId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'clientId' is set
            if (clientId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'clientId' when calling RoleAssignmentClientApi->ListRolesForClient");
            }
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ListGroupAssignedRoles200ResponseInner>("/oauth2/v1/clients/{clientId}/roles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Okta.Sdk.Client.ApiResponse<ListGroupAssignedRoles200ResponseInner>> RetrieveClientRoleWithHttpInfoAsync(  string clientId ,   string roleAssignmentId , System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (clientId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'clientId' when calling RoleAssignmentClientApi->RetrieveClientRole");
            }

            // verify the required parameter 'roleAssignmentId' is set
            if (roleAssignmentId == null)
            {
                throw new Okta.Sdk.Client.ApiException(400, "Missing required parameter 'roleAssignmentId' when calling RoleAssignmentClientApi->RetrieveClientRole");
            }
            ...
            if (Sdk.Client.Configuration.IsPrivateKeyMode(this.Configuration) && !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                await _oAuthTokenProvider.AddOrUpdateAuthorizationHeader(localVarRequestOptions, $"/oauth2/v1/clients/{clientId}/roles/{roleAssignmentId}", "GET", cancellationToken = default);
            }

...
namespace Okta.Sdk.Model
{
    ...
    public partial class HostedPage : IEquatable<HostedPage>
    {
        ...
        {
            return this.Equals(input as HostedPage);
        }

        /// <summary>
        /// Returns true if HostedPage instances are equal
        /// </summary>
        /// <param name="input">Instance of HostedPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HostedPage input)
        {
            if (input == null)
            {
                return false;

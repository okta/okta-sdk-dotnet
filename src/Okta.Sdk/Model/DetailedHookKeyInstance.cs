...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DetailedHookKeyInstance")]
    
    public partial class DetailedHookKeyInstance : IEquatable<DetailedHookKeyInstance>
    {
        ...
        /// </summary>
        /// <value>The unique Okta ID of this key record</value>
        ...
        /// </summary>
        /// <value>Whether this key is currently in use by other applications</value>
        [DataMember(Name = "isUsed", EmitDefaultValue = true)]
        public bool IsUsed { get; private set; }

        /// <summary>
        /// Returns false as IsUsed should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIsUsed()
        {
            return false;
        }
        /// <summary>
        ...
        {
            return this.Equals(input as DetailedHookKeyInstance);
        }

        /// <summary>
        /// Returns true if DetailedHookKeyInstance instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedHookKeyInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedHookKeyInstance input)
        {
            if (input == null)
            {
                return false;

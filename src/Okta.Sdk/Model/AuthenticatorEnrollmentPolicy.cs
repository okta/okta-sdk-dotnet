...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatorEnrollmentPolicy")]
    ...
    public partial class AuthenticatorEnrollmentPolicy : Policy, IEquatable<AuthenticatorEnrollmentPolicy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatorEnrollmentPolicy" /> class.
        /// </summary>
        ...
        public AuthenticatorEnrollmentPolicyConditions Conditions { get; set; }

        /// <summary>
        /// Gets or Sets Settings
        /// </summary>
        [DataMember(Name = "settings", EmitDefaultValue = true)]
        public AuthenticatorEnrollmentPolicySettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorEnrollmentPolicy {\n");
        ...
        {
            return this.Equals(input as AuthenticatorEnrollmentPolicy);
        }

        /// <summary>
        /// Returns true if AuthenticatorEnrollmentPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorEnrollmentPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorEnrollmentPolicy input)
        {
            if (input == null)
            {
                return false;

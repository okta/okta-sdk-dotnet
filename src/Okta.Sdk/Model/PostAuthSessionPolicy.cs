...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAuthSessionPolicy")]
    ...
    public partial class PostAuthSessionPolicy : Policy, IEquatable<PostAuthSessionPolicy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAuthSessionPolicy" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostAuthSessionPolicy);
        }

        /// <summary>
        /// Returns true if PostAuthSessionPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAuthSessionPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAuthSessionPolicy input)
        {
            if (input == null)
            {
                return false;

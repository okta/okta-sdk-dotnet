...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsLink")]
    
    public partial class GroupsLink : IEquatable<GroupsLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupsLink" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GroupsLink);
        }

        /// <summary>
        /// Returns true if GroupsLink instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsLink input)
        {
            if (input == null)
            {
                return false;

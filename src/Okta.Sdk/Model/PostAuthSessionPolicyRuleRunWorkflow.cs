...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAuthSessionPolicyRuleRunWorkflow")]
    
    public partial class PostAuthSessionPolicyRuleRunWorkflow : IEquatable<PostAuthSessionPolicyRuleRunWorkflow>
    {
        /// <summary>
        /// Defines Action
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostAuthSessionPolicyRuleRunWorkflow {\n");
        ...
        {
            return this.Equals(input as PostAuthSessionPolicyRuleRunWorkflow);
        }

        /// <summary>
        /// Returns true if PostAuthSessionPolicyRuleRunWorkflow instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAuthSessionPolicyRuleRunWorkflow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAuthSessionPolicyRuleRunWorkflow input)
        {
            if (input == null)
            {
                return false;

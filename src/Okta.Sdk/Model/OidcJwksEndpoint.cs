...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OidcJwksEndpoint")]
    
    public partial class OidcJwksEndpoint : IEquatable<OidcJwksEndpoint>
    {
        ...
        /// </summary>
        /// <value>URL of the endpoint to the JWK Set</value>
        ...
        {
            return this.Equals(input as OidcJwksEndpoint);
        }

        /// <summary>
        /// Returns true if OidcJwksEndpoint instances are equal
        /// </summary>
        /// <param name="input">Instance of OidcJwksEndpoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OidcJwksEndpoint input)
        {
            if (input == null)
            {
                return false;

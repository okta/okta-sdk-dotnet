...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProtocolIdVerification")]
    
    public partial class ProtocolIdVerification : IEquatable<ProtocolIdVerification>
    {
        /// <summary>
        /// ID verification protocol
        /// </summary>
        /// <value>ID verification protocol</value>
        [JsonConverter(typeof(StringEnumSerializingConverter))]
        public sealed class TypeEnum : StringEnum
        {
            /// <summary>
            /// StringEnum IDPROOFING for value: ID_PROOFING
            /// </summary>
            
            public static TypeEnum IDPROOFING = new TypeEnum("ID_PROOFING");
        ...
        public IDVCredentials Credentials { get; set; }

        /// <summary>
        /// Gets or Sets Endpoints
        /// </summary>
        [DataMember(Name = "endpoints", EmitDefaultValue = true)]
        public IDVEndpoints Endpoints { get; set; }
        ...
        {
            return this.Equals(input as ProtocolIdVerification);
        }

        /// <summary>
        /// Returns true if ProtocolIdVerification instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtocolIdVerification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtocolIdVerification input)
        {
            if (input == null)
            {
                return false;

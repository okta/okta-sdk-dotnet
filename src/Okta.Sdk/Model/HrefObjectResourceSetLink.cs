...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HrefObjectResourceSetLink")]
    
    public partial class HrefObjectResourceSetLink : IEquatable<HrefObjectResourceSetLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HrefObjectResourceSetLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public HrefObjectResourceSetLink() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HrefObjectResourceSetLink {\n");
        ...
        {
            return this.Equals(input as HrefObjectResourceSetLink);
        }

        /// <summary>
        /// Returns true if HrefObjectResourceSetLink instances are equal
        /// </summary>
        /// <param name="input">Instance of HrefObjectResourceSetLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HrefObjectResourceSetLink input)
        {
            if (input == null)
            {
                return false;

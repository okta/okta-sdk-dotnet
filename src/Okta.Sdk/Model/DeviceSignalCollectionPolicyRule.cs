...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceSignalCollectionPolicyRule")]
    ...
    public partial class DeviceSignalCollectionPolicyRule : PolicyRule, IEquatable<DeviceSignalCollectionPolicyRule>
    {
        ...
        public DeviceSignalCollectionPolicyRuleActions Actions { get; set; }

        /// <summary>
        /// Gets or Sets Conditions
        /// </summary>
        [DataMember(Name = "conditions", EmitDefaultValue = true)]
        public DeviceSignalCollectionPolicyRuleConditions Conditions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceSignalCollectionPolicyRule {\n");
        ...
        {
            return this.Equals(input as DeviceSignalCollectionPolicyRule);
        }

        /// <summary>
        /// Returns true if DeviceSignalCollectionPolicyRule instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceSignalCollectionPolicyRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceSignalCollectionPolicyRule input)
        {
            if (input == null)
            {
                return false;

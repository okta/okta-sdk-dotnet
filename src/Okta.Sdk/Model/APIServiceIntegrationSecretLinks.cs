...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "APIServiceIntegrationSecretLinks")]
    
    public partial class APIServiceIntegrationSecretLinks : IEquatable<APIServiceIntegrationSecretLinks>
    {
        ...
        {
            return this.Equals(input as APIServiceIntegrationSecretLinks);
        }

        /// <summary>
        /// Returns true if APIServiceIntegrationSecretLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of APIServiceIntegrationSecretLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(APIServiceIntegrationSecretLinks input)
        {
            if (input == null)
            {
                return false;

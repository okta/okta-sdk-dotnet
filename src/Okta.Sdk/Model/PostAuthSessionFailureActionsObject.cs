...
namespace Okta.Sdk.Model
{
    ...
    public partial class PostAuthSessionFailureActionsObject : IEquatable<PostAuthSessionFailureActionsObject>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostAuthSessionFailureActionsObject {\n");
        ...
        {
            return this.Equals(input as PostAuthSessionFailureActionsObject);
        }

        /// <summary>
        /// Returns true if PostAuthSessionFailureActionsObject instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAuthSessionFailureActionsObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAuthSessionFailureActionsObject input)
        {
            if (input == null)
            {
                return false;

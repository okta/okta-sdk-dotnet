...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OktaUserRiskChangeEvent")]
    
    public partial class OktaUserRiskChangeEvent : IEquatable<OktaUserRiskChangeEvent>
    {
        /// <summary>
        /// Current risk level of the user
        /// </summary>
        /// <value>Current risk level of the user</value>
        ...
        /// </summary>
        /// <value>Previous risk level of the user</value>
        [JsonConverter(typeof(StringEnumSerializingConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OktaUserRiskChangeEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public OktaUserRiskChangeEvent() { }
        ...
        {
            return this.Equals(input as OktaUserRiskChangeEvent);
        }

        /// <summary>
        /// Returns true if OktaUserRiskChangeEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of OktaUserRiskChangeEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OktaUserRiskChangeEvent input)
        {
            if (input == null)
            {
                return false;

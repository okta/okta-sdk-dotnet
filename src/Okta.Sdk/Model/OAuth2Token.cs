...
namespace Okta.Sdk.Model
{
    ...
    public partial class OAuth2Token : IEquatable<OAuth2Token>
    {
        ...
        /// </summary>
        /// <value>Name of scopes attached to the Token</value>
        ...
        /// </summary>
        /// <value>Embedded resources related to the object if the &#x60;expand&#x60; query parameter is specified</value>
        ...
        {
            return this.Equals(input as OAuth2Token);
        }

        /// <summary>
        /// Returns true if OAuth2Token instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuth2Token to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuth2Token input)
        {
            if (input == null)
            {
                return false;

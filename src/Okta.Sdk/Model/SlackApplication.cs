...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SlackApplication")]
    
    public partial class SlackApplication : IEquatable<SlackApplication>
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        {
            /// <summary>
            /// StringEnum Slack for value: slack
            /// </summary>
            
            public static NameEnum Slack = new NameEnum("slack");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SlackApplication" /> class.
        /// </summary>
        ...
        public SlackApplicationSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SlackApplication {\n");
        ...
        {
            return this.Equals(input as SlackApplication);
        }

        /// <summary>
        /// Returns true if SlackApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of SlackApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SlackApplication input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public partial class AccessPolicyRuleApplicationSignOn : IEquatable<AccessPolicyRuleApplicationSignOn>
    {
        ...
        public AccessPolicyRuleApplicationSignOnAccess Access { get; set; }
        
        /// <summary>
        /// Gets or Sets KeepMeSignedIn
        /// </summary>
        [DataMember(Name = "keepMeSignedIn", EmitDefaultValue = true)]
        public KeepMeSignedIn KeepMeSignedIn { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  KeepMeSignedIn: ").Append(KeepMeSignedIn).Append("\n");
        ...
        public bool Equals(AccessPolicyRuleApplicationSignOn input)
        {
            ...
            return 
                ...
                (
                    this.KeepMeSignedIn == input.KeepMeSignedIn ||
                    (this.KeepMeSignedIn != null &&
                    this.KeepMeSignedIn.Equals(input.KeepMeSignedIn))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KeepMeSignedIn != null)
                {
                    hashCode = (hashCode * 59) + this.KeepMeSignedIn.GetHashCode();
                }

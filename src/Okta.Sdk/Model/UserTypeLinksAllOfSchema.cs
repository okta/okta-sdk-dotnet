...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserTypeLinks_allOf_schema")]
    
    public partial class UserTypeLinksAllOfSchema : IEquatable<UserTypeLinksAllOfSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTypeLinksAllOfSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public UserTypeLinksAllOfSchema() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserTypeLinksAllOfSchema {\n");
        ...
        {
            return this.Equals(input as UserTypeLinksAllOfSchema);
        }

        /// <summary>
        /// Returns true if UserTypeLinksAllOfSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTypeLinksAllOfSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTypeLinksAllOfSchema input)
        {
            if (input == null)
            {
                return false;

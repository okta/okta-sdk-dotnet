...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgPreferences__links_hideEndUserFooter")]
    
    public partial class OrgPreferencesLinksHideEndUserFooter : IEquatable<OrgPreferencesLinksHideEndUserFooter>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgPreferencesLinksHideEndUserFooter" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OrgPreferencesLinksHideEndUserFooter);
        }

        /// <summary>
        /// Returns true if OrgPreferencesLinksHideEndUserFooter instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgPreferencesLinksHideEndUserFooter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgPreferencesLinksHideEndUserFooter input)
        {
            if (input == null)
            {
                return false;

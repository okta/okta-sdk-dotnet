...
namespace Okta.Sdk.Model
{
    ...
    /// An RSA signing key
    /// </summary>
    [DataContract(Name = "OAuth2ClientJsonWebKeyRsaRequest")]
    
    public partial class OAuth2ClientJsonWebKeyRsaRequest : IEquatable<OAuth2ClientJsonWebKeyRsaRequest>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OAuth2ClientJsonWebKeyRsaRequest);
        }

        /// <summary>
        /// Returns true if OAuth2ClientJsonWebKeyRsaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuth2ClientJsonWebKeyRsaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuth2ClientJsonWebKeyRsaRequest input)
        {
            if (input == null)
            {
                return false;

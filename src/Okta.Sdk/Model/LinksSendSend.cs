...
namespace Okta.Sdk.Model
{
    ...
    /// LinksSendSend
    /// </summary>
    [DataContract(Name = "LinksSend_send")]
    
    public partial class LinksSendSend : IEquatable<LinksSendSend>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksSendSend" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public LinksSendSend() { }
        ...
        {
            return this.Equals(input as LinksSendSend);
        }

        /// <summary>
        /// Returns true if LinksSendSend instances are equal
        /// </summary>
        /// <param name="input">Instance of LinksSendSend to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksSendSend input)
        {
            if (input == null)
            {
                return false;

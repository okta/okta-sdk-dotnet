...
namespace Okta.Sdk.Model
{
    ...
    /// BundleEntitlementsResponseNext
    /// </summary>
    [DataContract(Name = "BundleEntitlementsResponse_next")]
    
    public partial class BundleEntitlementsResponseNext : IEquatable<BundleEntitlementsResponseNext>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BundleEntitlementsResponseNext" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public BundleEntitlementsResponseNext() { }
        ...
        {
            return this.Equals(input as BundleEntitlementsResponseNext);
        }

        /// <summary>
        /// Returns true if BundleEntitlementsResponseNext instances are equal
        /// </summary>
        /// <param name="input">Instance of BundleEntitlementsResponseNext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BundleEntitlementsResponseNext input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public partial class HelpLink : IEquatable<HelpLink>
    {
        ...
        {
            return this.Equals(input as HelpLink);
        }

        /// <summary>
        /// Returns true if HelpLink instances are equal
        /// </summary>
        /// <param name="input">Instance of HelpLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelpLink input)
        {
            if (input == null)
            {
                return false;

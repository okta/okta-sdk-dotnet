...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserFactorSecurityQuestion")]
    ...
    public partial class UserFactorSecurityQuestion : UserFactor, IEquatable<UserFactorSecurityQuestion>
    {
        /// <summary>
        /// Defines Provider
        /// </summary>
        ...
        public UserFactorSecurityQuestionProfile Profile { get; set; }
        ...
        {
            return this.Equals(input as UserFactorSecurityQuestion);
        }

        /// <summary>
        /// Returns true if UserFactorSecurityQuestion instances are equal
        /// </summary>
        /// <param name="input">Instance of UserFactorSecurityQuestion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFactorSecurityQuestion input)
        {
            if (input == null)
            {
                return false;

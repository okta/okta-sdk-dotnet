...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatorEnrollmentPolicyRule")]
    ...
    public partial class AuthenticatorEnrollmentPolicyRule : PolicyRule, IEquatable<AuthenticatorEnrollmentPolicyRule>
    {
        ...
        public AuthenticatorEnrollmentPolicyRuleActions Actions { get; set; }

        /// <summary>
        /// Gets or Sets Conditions
        /// </summary>
        [DataMember(Name = "conditions", EmitDefaultValue = true)]
        public AuthenticatorEnrollmentPolicyRuleConditions Conditions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorEnrollmentPolicyRule {\n");
        ...
        {
            return this.Equals(input as AuthenticatorEnrollmentPolicyRule);
        }

        /// <summary>
        /// Returns true if AuthenticatorEnrollmentPolicyRule instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorEnrollmentPolicyRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorEnrollmentPolicyRule input)
        {
            if (input == null)
            {
                return false;

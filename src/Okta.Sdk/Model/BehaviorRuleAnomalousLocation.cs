...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BehaviorRuleAnomalousLocation")]
    ...
    public partial class BehaviorRuleAnomalousLocation : BehaviorRule, IEquatable<BehaviorRuleAnomalousLocation>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BehaviorRuleAnomalousLocation);
        }

        /// <summary>
        /// Returns true if BehaviorRuleAnomalousLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of BehaviorRuleAnomalousLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BehaviorRuleAnomalousLocation input)
        {
            if (input == null)
            {
                return false;

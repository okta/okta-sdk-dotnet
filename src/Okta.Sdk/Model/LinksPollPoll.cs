...
namespace Okta.Sdk.Model
{
    ...
    /// LinksPollPoll
    /// </summary>
    [DataContract(Name = "LinksPoll_poll")]
    
    public partial class LinksPollPoll : IEquatable<LinksPollPoll>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksPollPoll" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public LinksPollPoll() { }
        ...
        {
            return this.Equals(input as LinksPollPoll);
        }

        /// <summary>
        /// Returns true if LinksPollPoll instances are equal
        /// </summary>
        /// <param name="input">Instance of LinksPollPoll to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksPollPoll input)
        {
            if (input == null)
            {
                return false;

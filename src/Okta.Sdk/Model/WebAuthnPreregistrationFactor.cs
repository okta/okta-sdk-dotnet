...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebAuthnPreregistrationFactor")]
    
    public partial class WebAuthnPreregistrationFactor : IEquatable<WebAuthnPreregistrationFactor>
    {
        ...
        /// </summary>
        /// <value>Timestamp indicating when the factor was enrolled</value>
        ...
        /// </summary>
        /// <value>Timestamp indicating when the factor was last updated</value>
        ...
        /// </summary>
        /// <value>Name of the factor vendor. This is usually the same as the provider.</value>
        ...
        {
            return this.Equals(input as WebAuthnPreregistrationFactor);
        }

        /// <summary>
        /// Returns true if WebAuthnPreregistrationFactor instances are equal
        /// </summary>
        /// <param name="input">Instance of WebAuthnPreregistrationFactor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebAuthnPreregistrationFactor input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgOktaCommunicationSetting__links_optIn")]
    
    public partial class OrgOktaCommunicationSettingLinksOptIn : IEquatable<OrgOktaCommunicationSettingLinksOptIn>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgOktaCommunicationSettingLinksOptIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public OrgOktaCommunicationSettingLinksOptIn() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrgOktaCommunicationSettingLinksOptIn {\n");
        ...
        {
            return this.Equals(input as OrgOktaCommunicationSettingLinksOptIn);
        }

        /// <summary>
        /// Returns true if OrgOktaCommunicationSettingLinksOptIn instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgOktaCommunicationSettingLinksOptIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgOktaCommunicationSettingLinksOptIn input)
        {
            if (input == null)
            {
                return false;

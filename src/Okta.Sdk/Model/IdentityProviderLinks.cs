...
namespace Okta.Sdk.Model
{
    ...
    
    {
        ...
        /// </summary>
        /// <value>SAML 2.0 Assertion Consumer Service URL for the Okta SP</value>
        [DataMember(Name = "acs", EmitDefaultValue = true)]
        public HrefObject Acs { get; set; }

        /// <summary>
        /// OAuth 2.0 authorization endpoint for the IdP OAuth 2.0 Authorization Code flow
        /// </summary>
        /// <value>OAuth 2.0 authorization endpoint for the IdP OAuth 2.0 Authorization Code flow</value>
        [DataMember(Name = "authorize", EmitDefaultValue = true)]
        public HrefObject Authorize { get; set; }

        /// <summary>
        /// Redirect URI for the OAuth 2.0 Authorization Code flow
        /// </summary>
        /// <value>Redirect URI for the OAuth 2.0 Authorization Code flow</value>
        [DataMember(Name = "clientRedirectUri", EmitDefaultValue = true)]
        public HrefObject ClientRedirectUri { get; set; }

        /// <summary>
        /// Federation metadata document for the IdP (for example: SAML 2.0 Metadata)
        /// </summary>
        /// <value>Federation metadata document for the IdP (for example: SAML 2.0 Metadata)</value>
        ...
        /// IdP keys
        /// </summary>
        /// <value>IdP keys</value>
        [DataMember(Name = "keys", EmitDefaultValue = true)]
        public HrefObject Keys { get; set; }

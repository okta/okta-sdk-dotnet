...
namespace Okta.Sdk.Model
{
    ...
    /// LogStreamLinks
    /// </summary>
    [DataContract(Name = "LogStream__links")]
    
    public partial class LogStreamLinks : IEquatable<LogStreamLinks>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogStreamLinks {\n");
        ...
        {
            return this.Equals(input as LogStreamLinks);
        }

        /// <summary>
        /// Returns true if LogStreamLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of LogStreamLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogStreamLinks input)
        {
            if (input == null)
            {
                return false;

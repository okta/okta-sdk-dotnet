...
namespace Okta.Sdk.Model
{
    ...
    /// BundleEntitlementsResponseBundle
    /// </summary>
    [DataContract(Name = "BundleEntitlementsResponse_bundle")]
    
    public partial class BundleEntitlementsResponseBundle : IEquatable<BundleEntitlementsResponseBundle>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BundleEntitlementsResponseBundle" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public BundleEntitlementsResponseBundle() { }
        ...
        {
            return this.Equals(input as BundleEntitlementsResponseBundle);
        }

        /// <summary>
        /// Returns true if BundleEntitlementsResponseBundle instances are equal
        /// </summary>
        /// <param name="input">Instance of BundleEntitlementsResponseBundle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BundleEntitlementsResponseBundle input)
        {
            if (input == null)
            {
                return false;

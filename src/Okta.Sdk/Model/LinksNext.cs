...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinksNext")]
    
    public partial class LinksNext : IEquatable<LinksNext>
    {
        ...
        {
            return this.Equals(input as LinksNext);
        }

        /// <summary>
        /// Returns true if LinksNext instances are equal
        /// </summary>
        /// <param name="input">Instance of LinksNext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksNext input)
        {
            if (input == null)
            {
                return false;

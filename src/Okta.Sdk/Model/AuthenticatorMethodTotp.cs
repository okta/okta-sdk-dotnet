...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatorMethodTotp")]
    ...
    public partial class AuthenticatorMethodTotp : AuthenticatorMethodBase, IEquatable<AuthenticatorMethodTotp>
    {
        ...
        public AuthenticatorMethodTotpAllOfSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorMethodTotp {\n");
        ...
        {
            return this.Equals(input as AuthenticatorMethodTotp);
        }

        /// <summary>
        /// Returns true if AuthenticatorMethodTotp instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorMethodTotp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorMethodTotp input)
        {
            if (input == null)
            {
                return false;

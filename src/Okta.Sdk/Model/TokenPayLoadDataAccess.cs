...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenPayLoad_data_access")]
    
    public partial class TokenPayLoadDataAccess : IEquatable<TokenPayLoadDataAccess>
    {
        ...
        /// </summary>
        /// <value>The scopes contained in the token. For descriptions of the scopes that you can include, see the Okta [OpenID Connect and OAuth 2.0 API reference](/openapi/okta-oauth/guides/overview/#scopes).</value>
        ...
        {
            return this.Equals(input as TokenPayLoadDataAccess);
        }

        /// <summary>
        /// Returns true if TokenPayLoadDataAccess instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenPayLoadDataAccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenPayLoadDataAccess input)
        {
            if (input == null)
            {
                return false;

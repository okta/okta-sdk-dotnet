...
namespace Okta.Sdk.Model
{
    ...
    public partial class ClientPrivilegesSetting : IEquatable<ClientPrivilegesSetting>
    {
        ...
        public bool VarClientPrivilegesSetting { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarClientPrivilegesSetting: ").Append(VarClientPrivilegesSetting).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ClientPrivilegesSetting input)
        {
            ...
            return 
                (
                    this.VarClientPrivilegesSetting == input.VarClientPrivilegesSetting ||
                    this.VarClientPrivilegesSetting.Equals(input.VarClientPrivilegesSetting)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.VarClientPrivilegesSetting.GetHashCode();
                return hashCode;
            }
        }

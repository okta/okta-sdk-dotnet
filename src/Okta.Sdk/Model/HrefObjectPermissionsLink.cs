...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HrefObjectPermissionsLink")]
    
    public partial class HrefObjectPermissionsLink : IEquatable<HrefObjectPermissionsLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HrefObjectPermissionsLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public HrefObjectPermissionsLink() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HrefObjectPermissionsLink {\n");
        ...
        {
            return this.Equals(input as HrefObjectPermissionsLink);
        }

        /// <summary>
        /// Returns true if HrefObjectPermissionsLink instances are equal
        /// </summary>
        /// <param name="input">Instance of HrefObjectPermissionsLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HrefObjectPermissionsLink input)
        {
            if (input == null)
            {
                return false;

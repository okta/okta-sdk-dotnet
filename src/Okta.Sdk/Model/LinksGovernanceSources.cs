...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinksGovernanceSources")]
    
    public partial class LinksGovernanceSources : IEquatable<LinksGovernanceSources>
    {
        ...
        public HrefObjectUserLink Assignee { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinksGovernanceSources {\n");
        ...
        {
            return this.Equals(input as LinksGovernanceSources);
        }

        /// <summary>
        /// Returns true if LinksGovernanceSources instances are equal
        /// </summary>
        /// <param name="input">Instance of LinksGovernanceSources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksGovernanceSources input)
        {
            if (input == null)
            {
                return false;

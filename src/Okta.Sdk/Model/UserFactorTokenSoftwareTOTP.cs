...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserFactorTokenSoftwareTOTP")]
    ...
    public partial class UserFactorTokenSoftwareTOTP : UserFactor, IEquatable<UserFactorTokenSoftwareTOTP>
    {
        /// <summary>
        /// Defines Provider
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserFactorTokenSoftwareTOTP {\n");
        ...
        {
            return this.Equals(input as UserFactorTokenSoftwareTOTP);
        }

        /// <summary>
        /// Returns true if UserFactorTokenSoftwareTOTP instances are equal
        /// </summary>
        /// <param name="input">Instance of UserFactorTokenSoftwareTOTP to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFactorTokenSoftwareTOTP input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdpDiscoveryPolicyRule")]
    ...
    public partial class IdpDiscoveryPolicyRule : PolicyRule, IEquatable<IdpDiscoveryPolicyRule>
    {
        ...
        public IdpPolicyRuleAction Actions { get; set; }

        /// <summary>
        /// Gets or Sets Conditions
        /// </summary>
        [DataMember(Name = "conditions", EmitDefaultValue = true)]
        public IdpDiscoveryPolicyRuleCondition Conditions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdpDiscoveryPolicyRule {\n");
        ...
        {
            return this.Equals(input as IdpDiscoveryPolicyRule);
        }

        /// <summary>
        /// Returns true if IdpDiscoveryPolicyRule instances are equal
        /// </summary>
        /// <param name="input">Instance of IdpDiscoveryPolicyRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdpDiscoveryPolicyRule input)
        {
            if (input == null)
            {
                return false;

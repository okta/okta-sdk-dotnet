...
namespace Okta.Sdk.Model
{
    ...
    /// AuthenticatorKeyTac
    /// </summary>
    [DataContract(Name = "AuthenticatorKeyTac")]
    ...
    public partial class AuthenticatorKeyTac : AuthenticatorSimple, IEquatable<AuthenticatorKeyTac>
    {
        ...
        public AuthenticatorKeyTacAllOfProvider Provider { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorKeyTac {\n");
        ...
        {
            return this.Equals(input as AuthenticatorKeyTac);
        }

        /// <summary>
        /// Returns true if AuthenticatorKeyTac instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorKeyTac to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorKeyTac input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public partial class PrivilegedResource : IEquatable<PrivilegedResource>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrivilegedResource" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets CredentialSyncInfo
        /// </summary>
        [DataMember(Name = "credentialSyncInfo", EmitDefaultValue = true)]
        public CredentialSyncInfo CredentialSyncInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CredentialSyncInfo: ").Append(CredentialSyncInfo).Append("\n");
        ...
        public bool Equals(PrivilegedResource input)
        {
            ...
            return 
                ...
                (
                    this.CredentialSyncInfo == input.CredentialSyncInfo ||
                    (this.CredentialSyncInfo != null &&
                    this.CredentialSyncInfo.Equals(input.CredentialSyncInfo))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CredentialSyncInfo != null)
                {
                    hashCode = (hashCode * 59) + this.CredentialSyncInfo.GetHashCode();
                }
                if (this.Id != null)
                {

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UsersLink")]
    
    public partial class UsersLink : IEquatable<UsersLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersLink" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UsersLink);
        }

        /// <summary>
        /// Returns true if UsersLink instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersLink input)
        {
            if (input == null)
            {
                return false;

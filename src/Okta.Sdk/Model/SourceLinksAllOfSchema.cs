...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SourceLinks_allOf_schema")]
    
    public partial class SourceLinksAllOfSchema : IEquatable<SourceLinksAllOfSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceLinksAllOfSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SourceLinksAllOfSchema() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SourceLinksAllOfSchema {\n");
        ...
        {
            return this.Equals(input as SourceLinksAllOfSchema);
        }

        /// <summary>
        /// Returns true if SourceLinksAllOfSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceLinksAllOfSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceLinksAllOfSchema input)
        {
            if (input == null)
            {
                return false;

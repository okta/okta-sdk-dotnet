...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogStreamAwsPutSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public LogStreamAwsPutSchema() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogStreamAwsPutSchema {\n");
        ...
        {
            return this.Equals(input as LogStreamAwsPutSchema);
        }

        /// <summary>
        /// Returns true if LogStreamAwsPutSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of LogStreamAwsPutSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogStreamAwsPutSchema input)
        {
            if (input == null)
            {
                return false;

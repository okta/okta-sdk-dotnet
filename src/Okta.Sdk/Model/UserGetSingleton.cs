...
namespace Okta.Sdk.Model
{
    ...
    /// UserGetSingleton
    /// </summary>
    [DataContract(Name = "UserGetSingleton")]
    
    public partial class UserGetSingleton : IEquatable<UserGetSingleton>
    {
        ...
        public UserGetSingletonAllOfEmbedded Embedded { get; set; }
        ...
        {
            return this.Equals(input as UserGetSingleton);
        }

        /// <summary>
        /// Returns true if UserGetSingleton instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGetSingleton to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGetSingleton input)
        {
            if (input == null)
            {
                return false;

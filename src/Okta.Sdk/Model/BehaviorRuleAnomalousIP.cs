...
namespace Okta.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BehaviorRuleAnomalousIP" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public BehaviorRuleAnomalousIP() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BehaviorRuleAnomalousIP {\n");
        ...
        {
            return this.Equals(input as BehaviorRuleAnomalousIP);
        }

        /// <summary>
        /// Returns true if BehaviorRuleAnomalousIP instances are equal
        /// </summary>
        /// <param name="input">Instance of BehaviorRuleAnomalousIP to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BehaviorRuleAnomalousIP input)
        {
            if (input == null)
            {
                return false;

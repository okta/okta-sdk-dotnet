...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RiskDetectionTypesPolicyRuleCondition")]
    
    public partial class RiskDetectionTypesPolicyRuleCondition : IEquatable<RiskDetectionTypesPolicyRuleCondition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskDetectionTypesPolicyRuleCondition" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RiskDetectionTypesPolicyRuleCondition);
        }

        /// <summary>
        /// Returns true if RiskDetectionTypesPolicyRuleCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of RiskDetectionTypesPolicyRuleCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskDetectionTypesPolicyRuleCondition input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthServerLinks_allOf_policies")]
    
    public partial class AuthServerLinksAllOfPolicies : IEquatable<AuthServerLinksAllOfPolicies>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthServerLinksAllOfPolicies" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AuthServerLinksAllOfPolicies() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthServerLinksAllOfPolicies {\n");
        ...
        {
            return this.Equals(input as AuthServerLinksAllOfPolicies);
        }

        /// <summary>
        /// Returns true if AuthServerLinksAllOfPolicies instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthServerLinksAllOfPolicies to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthServerLinksAllOfPolicies input)
        {
            if (input == null)
            {
                return false;

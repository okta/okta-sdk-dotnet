...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityProvider__links_allOf_metadata")]
    
    public partial class IdentityProviderLinksAllOfMetadata : IEquatable<IdentityProviderLinksAllOfMetadata>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityProviderLinksAllOfMetadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public IdentityProviderLinksAllOfMetadata() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityProviderLinksAllOfMetadata {\n");
        ...
        {
            return this.Equals(input as IdentityProviderLinksAllOfMetadata);
        }

        /// <summary>
        /// Returns true if IdentityProviderLinksAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityProviderLinksAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityProviderLinksAllOfMetadata input)
        {
            if (input == null)
            {
                return false;

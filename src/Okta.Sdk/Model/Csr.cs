...
namespace Okta.Sdk.Model
{
    ...
    public partial class Csr : IEquatable<Csr>
    {
        ...
        public string VarCsr { get; private set; }

        /// <summary>
        /// Returns false as VarCsr should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeVarCsr()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarCsr: ").Append(VarCsr).Append("\n");
        ...
        public bool Equals(Csr input)
        {
            ...
            return 
                ...
                (
                    this.VarCsr == input.VarCsr ||
                    (this.VarCsr != null &&
                    this.VarCsr.Equals(input.VarCsr))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VarCsr != null)
                {
                    hashCode = (hashCode * 59) + this.VarCsr.GetHashCode();
                }
                if (this.Id != null)
                {

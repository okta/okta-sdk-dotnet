...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orgGeneralSettingLinks_oktaSupport")]
    
    public partial class OrgGeneralSettingLinksOktaSupport : IEquatable<OrgGeneralSettingLinksOktaSupport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgGeneralSettingLinksOktaSupport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public OrgGeneralSettingLinksOktaSupport() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrgGeneralSettingLinksOktaSupport {\n");
        ...
        {
            return this.Equals(input as OrgGeneralSettingLinksOktaSupport);
        }

        /// <summary>
        /// Returns true if OrgGeneralSettingLinksOktaSupport instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgGeneralSettingLinksOktaSupport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgGeneralSettingLinksOktaSupport input)
        {
            if (input == null)
            {
                return false;

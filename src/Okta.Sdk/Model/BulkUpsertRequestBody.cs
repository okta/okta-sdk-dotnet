...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkUpsertRequestBody")]
    
    public partial class BulkUpsertRequestBody : IEquatable<BulkUpsertRequestBody>
    {
        /// <summary>
        /// The type of data to upsert into the session. Currently, only &#x60;USERS&#x60; is supported.
        /// </summary>
        /// <value>The type of data to upsert into the session. Currently, only &#x60;USERS&#x60; is supported.</value>
        ...
        /// </summary>
        /// <value>Array of user profiles to be uploaded</value>
        [DataMember(Name = "profiles", EmitDefaultValue = true)]
        public List<BulkUpsertRequestBodyProfilesInner> Profiles { get; set; }
        ...
        {
            return this.Equals(input as BulkUpsertRequestBody);
        }

        /// <summary>
        /// Returns true if BulkUpsertRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkUpsertRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkUpsertRequestBody input)
        {
            if (input == null)
            {
                return false;

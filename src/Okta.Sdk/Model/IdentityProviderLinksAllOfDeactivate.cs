...
namespace Okta.Sdk.Model
{
    ...
    /// Deactivate IdP
    /// </summary>
    [DataContract(Name = "IdentityProvider__links_allOf_deactivate")]
    
    public partial class IdentityProviderLinksAllOfDeactivate : IEquatable<IdentityProviderLinksAllOfDeactivate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityProviderLinksAllOfDeactivate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public IdentityProviderLinksAllOfDeactivate() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityProviderLinksAllOfDeactivate {\n");
        ...
        {
            return this.Equals(input as IdentityProviderLinksAllOfDeactivate);
        }

        /// <summary>
        /// Returns true if IdentityProviderLinksAllOfDeactivate instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityProviderLinksAllOfDeactivate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityProviderLinksAllOfDeactivate input)
        {
            if (input == null)
            {
                return false;

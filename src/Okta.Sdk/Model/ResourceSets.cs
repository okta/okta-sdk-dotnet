...
namespace Okta.Sdk.Model
{
    ...
    public partial class ResourceSets : IEquatable<ResourceSets>
    {
        ...
        /// <summary>
        /// Gets or Sets VarResourceSets
        /// </summary>
        [DataMember(Name = "resource-sets", EmitDefaultValue = true)]
        public List<ResourceSet> VarResourceSets { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarResourceSets: ").Append(VarResourceSets).Append("\n");
        ...
        public bool Equals(ResourceSets input)
        {
            ...
            return 
                (
                    this.VarResourceSets == input.VarResourceSets ||
                    this.VarResourceSets != null &&
                    input.VarResourceSets != null &&
                    this.VarResourceSets.SequenceEqual(input.VarResourceSets)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VarResourceSets != null)
                {
                    hashCode = (hashCode * 59) + this.VarResourceSets.GetHashCode();
                }
                if (this.Links != null)
                {

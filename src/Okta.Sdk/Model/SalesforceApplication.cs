...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SalesforceApplication")]
    
    public partial class SalesforceApplication : IEquatable<SalesforceApplication>
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        {
            /// <summary>
            /// StringEnum Salesforce for value: salesforce
            /// </summary>
            
            public static NameEnum Salesforce = new NameEnum("salesforce");
        ...
        public sealed class SignOnModeEnum : StringEnum
        {
            ...
            public static SignOnModeEnum BOOKMARK = new SignOnModeEnum("BOOKMARK");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesforceApplication" /> class.
        /// </summary>
        ...
        public SalesforceApplicationSettings Settings { get; set; }
        ...
        {
            return this.Equals(input as SalesforceApplication);
        }

        /// <summary>
        /// Returns true if SalesforceApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesforceApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesforceApplication input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    /// <value>User verification setting. Possible values &#x60;DISCOURAGED&#x60; (the authenticator isn&#39;t asked to perform user verification, but may do so at its discretion), &#x60;PREFERRED&#x60; (the client uses an authenticator capable of user verification if possible), or &#x60;REQUIRED&#x60;(the client uses only an authenticator capable of user verification)</value>
    [JsonConverter(typeof(StringEnumSerializingConverter))]
    public sealed class UserVerificationEnum : StringEnum
    {
        /// <summary>
        /// StringEnum UserVerificationEnum for value: DISCOURAGED
        /// </summary>
        public static UserVerificationEnum DISCOURAGED = new UserVerificationEnum("DISCOURAGED");
        /// <summary>

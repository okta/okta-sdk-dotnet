...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SAMLHookResponse_error")]
    
    public partial class SAMLHookResponseError : IEquatable<SAMLHookResponseError>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SAMLHookResponseError {\n");
        ...
        {
            return this.Equals(input as SAMLHookResponseError);
        }

        /// <summary>
        /// Returns true if SAMLHookResponseError instances are equal
        /// </summary>
        /// <param name="input">Instance of SAMLHookResponseError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SAMLHookResponseError input)
        {
            if (input == null)
            {
                return false;

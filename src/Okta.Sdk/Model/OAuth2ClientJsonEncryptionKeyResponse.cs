...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OAuth2ClientJsonEncryptionKeyResponse")]
    
    public partial class OAuth2ClientJsonEncryptionKeyResponse : IEquatable<OAuth2ClientJsonEncryptionKeyResponse>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OAuth2ClientJsonEncryptionKeyResponse {\n");
        ...
        {
            return this.Equals(input as OAuth2ClientJsonEncryptionKeyResponse);
        }

        /// <summary>
        /// Returns true if OAuth2ClientJsonEncryptionKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuth2ClientJsonEncryptionKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuth2ClientJsonEncryptionKeyResponse input)
        {
            if (input == null)
            {
                return false;

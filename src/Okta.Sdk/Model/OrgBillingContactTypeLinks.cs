...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orgBillingContactType__links")]
    
    public partial class OrgBillingContactTypeLinks : IEquatable<OrgBillingContactTypeLinks>
    {
        ...
        /// </summary>
        /// <value>Link to the org billing [contact type user](/openapi/okta-management/management/tag/OrgSettingContact/#tag/OrgSettingContact/operation/getOrgContactUser) resource</value>
        [DataMember(Name = "billing", EmitDefaultValue = true)]
        public HrefObject Billing { get; set; }
        ...
        {
            return this.Equals(input as OrgBillingContactTypeLinks);
        }

        /// <summary>
        /// Returns true if OrgBillingContactTypeLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgBillingContactTypeLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgBillingContactTypeLinks input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orgGeneralSettingLinks_oktaCommunication")]
    
    public partial class OrgGeneralSettingLinksOktaCommunication : IEquatable<OrgGeneralSettingLinksOktaCommunication>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgGeneralSettingLinksOktaCommunication" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public OrgGeneralSettingLinksOktaCommunication() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrgGeneralSettingLinksOktaCommunication {\n");
        ...
        {
            return this.Equals(input as OrgGeneralSettingLinksOktaCommunication);
        }

        /// <summary>
        /// Returns true if OrgGeneralSettingLinksOktaCommunication instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgGeneralSettingLinksOktaCommunication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgGeneralSettingLinksOktaCommunication input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public sealed class TokenType : StringEnum
    {
        ...
        /// </summary>
        public static TokenType UrnietfparamsoauthtokenTypeaccessToken = new TokenType("urn:ietf:params:oauth:token-type:access_token");
        /// <summary>
        /// StringEnum TokenType for value: urn:ietf:params:oauth:token-type:id_token
        /// </summary>
        public static TokenType UrnietfparamsoauthtokenTypeidToken = new TokenType("urn:ietf:params:oauth:token-type:id_token");
        /// <summary>
        /// StringEnum TokenType for value: urn:ietf:params:oauth:token-type:jwt
        /// </summary>
        public static TokenType UrnietfparamsoauthtokenTypejwt = new TokenType("urn:ietf:params:oauth:token-type:jwt");
        /// <summary>
        /// StringEnum TokenType for value: urn:ietf:params:oauth:token-type:refresh_token
        /// </summary>
        public static TokenType UrnietfparamsoauthtokenTyperefreshToken = new TokenType("urn:ietf:params:oauth:token-type:refresh_token");
        /// <summary>
        /// StringEnum TokenType for value: urn:ietf:params:oauth:token-type:saml1
        /// </summary>
        public static TokenType UrnietfparamsoauthtokenTypesaml1 = new TokenType("urn:ietf:params:oauth:token-type:saml1");
        /// <summary>
        /// StringEnum TokenType for value: urn:ietf:params:oauth:token-type:saml2
        /// </summary>
        public static TokenType UrnietfparamsoauthtokenTypesaml2 = new TokenType("urn:ietf:params:oauth:token-type:saml2");
        /// <summary>
        /// StringEnum TokenType for value: urn:okta:oauth:token-type:web_sso_token
        /// </summary>
        public static TokenType UrnoktaoauthtokenTypewebSsoToken = new TokenType("urn:okta:oauth:token-type:web_sso_token");
        /// <summary>
        /// StringEnum TokenType for value: urn:x-oath:params:oauth:token-type:device-secret
        /// </summary>
        public static TokenType UrnxOathparamsoauthtokenTypedeviceSecret = new TokenType("urn:x-oath:params:oauth:token-type:device-secret");

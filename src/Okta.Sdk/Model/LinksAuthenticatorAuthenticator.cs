...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinksAuthenticator_authenticator")]
    
    public partial class LinksAuthenticatorAuthenticator : IEquatable<LinksAuthenticatorAuthenticator>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksAuthenticatorAuthenticator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public LinksAuthenticatorAuthenticator() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinksAuthenticatorAuthenticator {\n");
        ...
        {
            return this.Equals(input as LinksAuthenticatorAuthenticator);
        }

        /// <summary>
        /// Returns true if LinksAuthenticatorAuthenticator instances are equal
        /// </summary>
        /// <param name="input">Instance of LinksAuthenticatorAuthenticator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksAuthenticatorAuthenticator input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public class EntitlementValuesResponseLinksJsonConverter : JsonConverter
    {
        ...
        {
            var instance = ((EntitlementValuesResponseLinks)value).ActualInstance;
            if (instance == null)
            {
                writer.WriteNull();
                return;
            ...
            var settings = new JsonSerializerSettings
            {
                ...
                Converters = serializer.Converters.Where(c => !(c is EntitlementValuesResponseLinksJsonConverter)).ToList()
            };

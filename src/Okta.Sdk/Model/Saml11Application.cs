...
namespace Okta.Sdk.Model
{
    ...
    /// Saml11Application
    /// </summary>
    [DataContract(Name = "Saml11Application")]
    ...
    public partial class Saml11Application : Application, IEquatable<Saml11Application>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Saml11Application" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The key name for the SAML 1.1 app definition. You can&#39;t create a custom SAML 1.1 app integration instance. Only existing OIN SAML 1.1 app integrations are supported.</value>
        ...
        public Saml11ApplicationSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Saml11Application {\n");
        ...
        {
            return this.Equals(input as Saml11Application);
        }

        /// <summary>
        /// Returns true if Saml11Application instances are equal
        /// </summary>
        /// <param name="input">Instance of Saml11Application to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Saml11Application input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatorMethodSimple")]
    ...
    public partial class AuthenticatorMethodSimple : AuthenticatorMethodBase, IEquatable<AuthenticatorMethodSimple>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorMethodSimple {\n");
        ...
        {
            return this.Equals(input as AuthenticatorMethodSimple);
        }

        /// <summary>
        /// Returns true if AuthenticatorMethodSimple instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorMethodSimple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorMethodSimple input)
        {
            if (input == null)
            {
                return false;

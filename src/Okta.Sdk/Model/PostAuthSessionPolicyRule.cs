...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostAuthSessionPolicyRule")]
    ...
    public partial class PostAuthSessionPolicyRule : PolicyRule, IEquatable<PostAuthSessionPolicyRule>
    {
        ...
        public PostAuthSessionPolicyRuleAllOfActions Actions { get; set; }

        /// <summary>
        /// Gets or Sets Conditions
        /// </summary>
        [DataMember(Name = "conditions", EmitDefaultValue = true)]
        public PostAuthSessionPolicyRuleAllOfConditions Conditions { get; set; }
        ...
        {
            return this.Equals(input as PostAuthSessionPolicyRule);
        }

        /// <summary>
        /// Returns true if PostAuthSessionPolicyRule instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAuthSessionPolicyRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAuthSessionPolicyRule input)
        {
            if (input == null)
            {
                return false;

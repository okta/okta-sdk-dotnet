...
namespace Okta.Sdk.Model
{
    ...
    /// UserFactorSMS
    /// </summary>
    [DataContract(Name = "UserFactorSMS")]
    ...
    public partial class UserFactorSMS : UserFactor, IEquatable<UserFactorSMS>
    {
        /// <summary>
        /// Defines Provider
        /// </summary>
        ...
        public UserFactorSMSProfile Profile { get; set; }
        ...
        {
            return this.Equals(input as UserFactorSMS);
        }

        /// <summary>
        /// Returns true if UserFactorSMS instances are equal
        /// </summary>
        /// <param name="input">Instance of UserFactorSMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFactorSMS input)
        {
            if (input == null)
            {
                return false;

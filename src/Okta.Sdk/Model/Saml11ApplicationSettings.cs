...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Saml11ApplicationSettings")]
    
    public partial class Saml11ApplicationSettings : IEquatable<Saml11ApplicationSettings>
    {
        /// <summary>
        ...
        public Saml11ApplicationSettingsSignOn SignOn { get; set; }
        ...
        {
            return this.Equals(input as Saml11ApplicationSettings);
        }

        /// <summary>
        /// Returns true if Saml11ApplicationSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of Saml11ApplicationSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Saml11ApplicationSettings input)
        {
            if (input == null)
            {
                return false;

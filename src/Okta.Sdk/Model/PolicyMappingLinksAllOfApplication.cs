...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PolicyMapping__links_allOf_application")]
    
    public partial class PolicyMappingLinksAllOfApplication : IEquatable<PolicyMappingLinksAllOfApplication>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyMappingLinksAllOfApplication" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PolicyMappingLinksAllOfApplication() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyMappingLinksAllOfApplication {\n");
        ...
        {
            return this.Equals(input as PolicyMappingLinksAllOfApplication);
        }

        /// <summary>
        /// Returns true if PolicyMappingLinksAllOfApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyMappingLinksAllOfApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyMappingLinksAllOfApplication input)
        {
            if (input == null)
            {
                return false;

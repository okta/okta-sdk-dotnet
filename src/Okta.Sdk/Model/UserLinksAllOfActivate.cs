...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User__links_allOf_activate")]
    
    public partial class UserLinksAllOfActivate : IEquatable<UserLinksAllOfActivate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserLinksAllOfActivate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public UserLinksAllOfActivate() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserLinksAllOfActivate {\n");
        ...
        {
            return this.Equals(input as UserLinksAllOfActivate);
        }

        /// <summary>
        /// Returns true if UserLinksAllOfActivate instances are equal
        /// </summary>
        /// <param name="input">Instance of UserLinksAllOfActivate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLinksAllOfActivate input)
        {
            if (input == null)
            {
                return false;

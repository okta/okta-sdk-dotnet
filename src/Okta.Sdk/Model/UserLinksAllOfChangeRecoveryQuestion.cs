...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User__links_allOf_changeRecoveryQuestion")]
    
    public partial class UserLinksAllOfChangeRecoveryQuestion : IEquatable<UserLinksAllOfChangeRecoveryQuestion>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserLinksAllOfChangeRecoveryQuestion" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public UserLinksAllOfChangeRecoveryQuestion() { }
        ...
        {
            return this.Equals(input as UserLinksAllOfChangeRecoveryQuestion);
        }

        /// <summary>
        /// Returns true if UserLinksAllOfChangeRecoveryQuestion instances are equal
        /// </summary>
        /// <param name="input">Instance of UserLinksAllOfChangeRecoveryQuestion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLinksAllOfChangeRecoveryQuestion input)
        {
            if (input == null)
            {
                return false;

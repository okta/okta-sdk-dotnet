...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebAuthnRpIdDomain_dnsRecord")]
    
    public partial class WebAuthnRpIdDomainDnsRecord : IEquatable<WebAuthnRpIdDomainDnsRecord>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebAuthnRpIdDomainDnsRecord {\n");
        ...
        {
            return this.Equals(input as WebAuthnRpIdDomainDnsRecord);
        }

        /// <summary>
        /// Returns true if WebAuthnRpIdDomainDnsRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of WebAuthnRpIdDomainDnsRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebAuthnRpIdDomainDnsRecord input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthServerLinks_allOf_claims")]
    
    public partial class AuthServerLinksAllOfClaims : IEquatable<AuthServerLinksAllOfClaims>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthServerLinksAllOfClaims" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AuthServerLinksAllOfClaims() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthServerLinksAllOfClaims {\n");
        ...
        {
            return this.Equals(input as AuthServerLinksAllOfClaims);
        }

        /// <summary>
        /// Returns true if AuthServerLinksAllOfClaims instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthServerLinksAllOfClaims to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthServerLinksAllOfClaims input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PolicyMapping__links_allOf_policy")]
    
    public partial class PolicyMappingLinksAllOfPolicy : IEquatable<PolicyMappingLinksAllOfPolicy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyMappingLinksAllOfPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PolicyMappingLinksAllOfPolicy() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyMappingLinksAllOfPolicy {\n");
        ...
        {
            return this.Equals(input as PolicyMappingLinksAllOfPolicy);
        }

        /// <summary>
        /// Returns true if PolicyMappingLinksAllOfPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyMappingLinksAllOfPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyMappingLinksAllOfPolicy input)
        {
            if (input == null)
            {
                return false;

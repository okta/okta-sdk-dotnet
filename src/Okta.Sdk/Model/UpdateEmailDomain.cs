...
namespace Okta.Sdk.Model
{
    ...
    public partial class UpdateEmailDomain : IEquatable<UpdateEmailDomain>
    {
        ...
        {
            return this.Equals(input as UpdateEmailDomain);
        }

        /// <summary>
        /// Returns true if UpdateEmailDomain instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEmailDomain to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEmailDomain input)
        {
            if (input == null)
            {
                return false;

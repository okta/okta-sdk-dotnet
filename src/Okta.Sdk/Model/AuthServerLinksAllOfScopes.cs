...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthServerLinks_allOf_scopes")]
    
    public partial class AuthServerLinksAllOfScopes : IEquatable<AuthServerLinksAllOfScopes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthServerLinksAllOfScopes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AuthServerLinksAllOfScopes() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthServerLinksAllOfScopes {\n");
        ...
        {
            return this.Equals(input as AuthServerLinksAllOfScopes);
        }

        /// <summary>
        /// Returns true if AuthServerLinksAllOfScopes instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthServerLinksAllOfScopes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthServerLinksAllOfScopes input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public partial class LogEvent : IEquatable<LogEvent>
    {
        ...
        /// Gets or Sets Actor
        /// </summary>
        [DataMember(Name = "actor", EmitDefaultValue = true)]
        ...
        public LogClient VarClient { get; set; }

        /// <summary>
        /// Gets or Sets DebugContext
        /// </summary>
        [DataMember(Name = "debugContext", EmitDefaultValue = true)]
        public LogDebugContext DebugContext { get; set; }

        /// <summary>
        /// The display message for an event
        /// </summary>
        /// <value>The display message for an event</value>
        ...
        /// </summary>
        /// <value>The published event type. Event instances are categorized by action in the event type attribute. This attribute is key to navigating the System Log through expression filters. See [Event Types catalog](https://developer.okta.com/docs/reference/api/event-types/#catalog) for a complete list of System Log event types.</value>
        ...
        /// </summary>
        /// <value>Associated Events API Action &#x60;objectType&#x60; attribute value</value>
        ...
        /// </summary>
        /// <value>Timestamp when the event is published</value>
        ...
        /// </summary>
        [DataMember(Name = "securityContext", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The entity that an actor performs an action on. Targets can be anything, such as an app user, a sign-in token, or anything else.  &gt; **Note:** When searching the target array, search for a given &#x60;type&#x60; rather than the array location. Target types, such as &#x60;User&#x60; and &#x60;AppInstance&#x60;, for a given &#x60;eventType&#x60; are not always in the same array location.</value>
        ...
        /// </summary>
        /// <value>Unique identifier for an individual event</value>
        ...
        /// </summary>
        /// <value>Versioning indicator</value>

...
namespace Okta.Sdk.Model
{
    ...
    public partial class BehaviorRuleSettingsVelocity : IEquatable<BehaviorRuleSettingsVelocity>
    {
        ...
        {
            return this.Equals(input as BehaviorRuleSettingsVelocity);
        }

        /// <summary>
        /// Returns true if BehaviorRuleSettingsVelocity instances are equal
        /// </summary>
        /// <param name="input">Instance of BehaviorRuleSettingsVelocity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BehaviorRuleSettingsVelocity input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthorizationServerPolicy_allOf__links")]
    
    public partial class AuthorizationServerPolicyAllOfLinks : IEquatable<AuthorizationServerPolicyAllOfLinks>
    {
        ...
        /// </summary>
        /// <value>Link to the authorization server policy&#39;s rules</value>
        [DataMember(Name = "rules", EmitDefaultValue = true)]
        public HrefObject Rules { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorizationServerPolicyAllOfLinks {\n");
        ...
        {
            return this.Equals(input as AuthorizationServerPolicyAllOfLinks);
        }

        /// <summary>
        /// Returns true if AuthorizationServerPolicyAllOfLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorizationServerPolicyAllOfLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorizationServerPolicyAllOfLinks input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BundleEntitlementsResponse__links_next")]
    
    public partial class BundleEntitlementsResponseLinksNext : IEquatable<BundleEntitlementsResponseLinksNext>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BundleEntitlementsResponseLinksNext" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public BundleEntitlementsResponseLinksNext() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BundleEntitlementsResponseLinksNext {\n");
        ...
        {
            return this.Equals(input as BundleEntitlementsResponseLinksNext);
        }

        /// <summary>
        /// Returns true if BundleEntitlementsResponseLinksNext instances are equal
        /// </summary>
        /// <param name="input">Instance of BundleEntitlementsResponseLinksNext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BundleEntitlementsResponseLinksNext input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sms_1")]
    
    public partial class Sms1 : IEquatable<Sms1>
    {
        ...
        {
            return this.Equals(input as Sms1);
        }

        /// <summary>
        /// Returns true if Sms1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Sms1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Sms1 input)
        {
            if (input == null)
            {
                return false;

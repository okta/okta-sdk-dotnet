...
namespace Okta.Sdk.Model
{
    ...
    public partial class SamlApplicationSettingsSignOn : IEquatable<SamlApplicationSettingsSignOn>
    {
        ...
        {
            /// <summary>
            /// StringEnum RSASHA1 for value: RSA_SHA1
            /// </summary>
            
            public static SignatureAlgorithmEnum RSASHA1 = new SignatureAlgorithmEnum("RSA_SHA1");

            /// <summary>
            /// StringEnum RSASHA256 for value: RSA_SHA256
            /// </summary>
            
            public static SignatureAlgorithmEnum RSASHA256 = new SignatureAlgorithmEnum("RSA_SHA256");
        ...
        {
            /// <summary>
            /// StringEnum UrnoasisnamestcSAML11nameidFormatemailAddress for value: urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress
            /// </summary>
            
            public static SubjectNameIdFormatEnum UrnoasisnamestcSAML11nameidFormatemailAddress = new SubjectNameIdFormatEnum("urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress");

            /// <summary>
            /// StringEnum UrnoasisnamestcSAML20nameidFormatpersistent for value: urn:oasis:names:tc:SAML:2.0:nameid-format:persistent
            /// </summary>
            
            public static SubjectNameIdFormatEnum UrnoasisnamestcSAML20nameidFormatpersistent = new SubjectNameIdFormatEnum("urn:oasis:names:tc:SAML:2.0:nameid-format:persistent");

            /// <summary>
            /// StringEnum UrnoasisnamestcSAML20nameidFormattransient for value: urn:oasis:names:tc:SAML:2.0:nameid-format:transient
            /// </summary>
            
            public static SubjectNameIdFormatEnum UrnoasisnamestcSAML20nameidFormattransient = new SubjectNameIdFormatEnum("urn:oasis:names:tc:SAML:2.0:nameid-format:transient");

            /// <summary>
            /// StringEnum UrnoasisnamestcSAML11nameidFormatunspecified for value: urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified
            /// </summary>
            
            public static SubjectNameIdFormatEnum UrnoasisnamestcSAML11nameidFormatunspecified = new SubjectNameIdFormatEnum("urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified");

            /// <summary>
            /// StringEnum UrnoasisnamestcSAML11nameidFormatx509SubjectName for value: urn:oasis:names:tc:SAML:1.1:nameid-format:x509SubjectName
            /// </summary>
            
            public static SubjectNameIdFormatEnum UrnoasisnamestcSAML11nameidFormatx509SubjectName = new SubjectNameIdFormatEnum("urn:oasis:names:tc:SAML:1.1:nameid-format:x509SubjectName");

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SecurePasswordStoreApplication")]
    ...
    public partial class SecurePasswordStoreApplication : Application, IEquatable<SecurePasswordStoreApplication>
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// StringEnum TemplateSps for value: template_sps
            /// </summary>
            
            public static NameEnum TemplateSps = new NameEnum("template_sps");
        ...
        {
            return this.Equals(input as SecurePasswordStoreApplication);
        }

        /// <summary>
        /// Returns true if SecurePasswordStoreApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurePasswordStoreApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurePasswordStoreApplication input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceSetResource__links_resource")]
    
    public partial class ResourceSetResourceLinksResource : IEquatable<ResourceSetResourceLinksResource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceSetResourceLinksResource" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ResourceSetResourceLinksResource() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceSetResourceLinksResource {\n");
        ...
        {
            return this.Equals(input as ResourceSetResourceLinksResource);
        }

        /// <summary>
        /// Returns true if ResourceSetResourceLinksResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceSetResourceLinksResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceSetResourceLinksResource input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OAuth2ResourceServerJsonWebKey")]
    
    public partial class OAuth2ResourceServerJsonWebKey : IEquatable<OAuth2ResourceServerJsonWebKey>
    {
        /// <summary>
        /// The status of the encryption key. You can use only an &#x60;ACTIVE&#x60; key to encrypt tokens issued by the authorization server.
        /// </summary>
        /// <value>The status of the encryption key. You can use only an &#x60;ACTIVE&#x60; key to encrypt tokens issued by the authorization server.</value>
        ...
        /// </summary>
        /// <value>Timestamp when the JSON Web Key was created</value>
        ...
        /// </summary>
        /// <value>The unique ID of the JSON Web Key</value>
        ...
        /// </summary>
        /// <value>Unique identifier of the JSON Web Key in the Custom Authorization Server&#39;s Public JWKS</value>
        ...
        /// </summary>
        /// <value>Timestamp when the JSON Web Key was updated</value>
        ...
        public OAuthResourceServerKeyLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OAuth2ResourceServerJsonWebKey {\n");
        ...
        {
            return this.Equals(input as OAuth2ResourceServerJsonWebKey);
        }

        /// <summary>
        /// Returns true if OAuth2ResourceServerJsonWebKey instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuth2ResourceServerJsonWebKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuth2ResourceServerJsonWebKey input)
        {
            if (input == null)
            {
                return false;

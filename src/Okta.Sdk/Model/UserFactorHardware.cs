...
namespace Okta.Sdk.Model
{
    ...
    /// UserFactorHardware
    /// </summary>
    [DataContract(Name = "UserFactorHardware")]
    [JsonConverter(typeof(JsonSubtypes), "FactorType")]
    
    public partial class UserFactorHardware : UserFactor, IEquatable<UserFactorHardware>
    {
        /// <summary>
        /// Defines Provider
        /// </summary>
        ...
        public UserFactorHardwareProfile Profile { get; set; }

        /// <summary>
        /// Gets or Sets Verify
        /// </summary>
        [DataMember(Name = "verify", EmitDefaultValue = true)]
        public UserFactorHardwareAllOfVerify Verify { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserFactorHardware {\n");
        ...
        {
            return this.Equals(input as UserFactorHardware);
        }

        /// <summary>
        /// Returns true if UserFactorHardware instances are equal
        /// </summary>
        /// <param name="input">Instance of UserFactorHardware to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFactorHardware input)
        {
            if (input == null)
            {
                return false;

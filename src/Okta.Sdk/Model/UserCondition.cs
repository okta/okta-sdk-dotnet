...
namespace Okta.Sdk.Model
{
    ...
    public partial class UserCondition : IEquatable<UserCondition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserCondition" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UserCondition);
        }

        /// <summary>
        /// Returns true if UserCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of UserCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCondition input)
        {
            if (input == null)
            {
                return false;

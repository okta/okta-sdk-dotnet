...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatorMethodPush")]
    ...
    public partial class AuthenticatorMethodPush : AuthenticatorMethodBase, IEquatable<AuthenticatorMethodPush>
    {
        ...
        public AuthenticatorMethodPushAllOfSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorMethodPush {\n");
        ...
        {
            return this.Equals(input as AuthenticatorMethodPush);
        }

        /// <summary>
        /// Returns true if AuthenticatorMethodPush instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorMethodPush to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorMethodPush input)
        {
            if (input == null)
            {
                return false;

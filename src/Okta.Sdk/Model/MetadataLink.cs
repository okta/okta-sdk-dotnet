...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataLink")]
    
    public partial class MetadataLink : IEquatable<MetadataLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataLink" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MetadataLink);
        }

        /// <summary>
        /// Returns true if MetadataLink instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataLink input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    public partial class IPNetworkZone : NetworkZone, IEquatable<IPNetworkZone>
    {
        ...
        /// </summary>
        /// <value>You can **only** use this parameter when making a request to the Replace the network zone endpoint (&#x60;/api/v1/zones/{zoneId}&#x60;). Set this parameter to &#x60;true&#x60; in your request when you update the &#x60;DefaultExemptIpZone&#x60; to allow IPs through the blocklist.</value>
        [DataMember(Name = "useAsExemptList", EmitDefaultValue = true)]
        public bool UseAsExemptList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UseAsExemptList: ").Append(UseAsExemptList).Append("\n");
        ...
        public bool Equals(IPNetworkZone input)
        {
            ...
            return base.Equals(input) && 
                (
                    this.UseAsExemptList == input.UseAsExemptList ||
                    this.UseAsExemptList.Equals(input.UseAsExemptList)
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.UseAsExemptList.GetHashCode();

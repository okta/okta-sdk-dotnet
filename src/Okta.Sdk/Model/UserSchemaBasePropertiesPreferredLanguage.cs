...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserSchemaBaseProperties_preferredLanguage")]
    
    public partial class UserSchemaBasePropertiesPreferredLanguage : IEquatable<UserSchemaBasePropertiesPreferredLanguage>
    {
        ...
        /// </summary>
        /// <value>If specified, assigns the value as the default value for the custom attribute. This is a nullable property. If you don&#39;t specify a value for this custom attribute during user creation or update, the &#x60;default&#x60; is used instead of setting the value to &#x60;null&#x60; or empty.</value>
        ...
        /// </summary>
        /// <value>Name of the property as it exists in an external application  **NOTE**: When you add a custom property, only Identity Provider app user schemas require &#x60;externalName&#x60; to be included in the request body. If an existing custom Identity Provider app user schema property has an empty &#x60;externalName&#x60;, requests aren&#39;t allowed to update other properties until the &#x60;externalName&#x60; is defined.</value>
        ...
        /// </summary>
        /// <value>For &#x60;string&#x60; property types, specifies the regular expression used to validate the property</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserSchemaBasePropertiesPreferredLanguage {\n");
        ...
        {
            return this.Equals(input as UserSchemaBasePropertiesPreferredLanguage);
        }

        /// <summary>
        /// Returns true if UserSchemaBasePropertiesPreferredLanguage instances are equal
        /// </summary>
        /// <param name="input">Instance of UserSchemaBasePropertiesPreferredLanguage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserSchemaBasePropertiesPreferredLanguage input)
        {
            if (input == null)
            {
                return false;

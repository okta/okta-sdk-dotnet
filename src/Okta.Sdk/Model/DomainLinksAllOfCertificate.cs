...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DomainLinks_allOf_certificate")]
    
    public partial class DomainLinksAllOfCertificate : IEquatable<DomainLinksAllOfCertificate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainLinksAllOfCertificate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public DomainLinksAllOfCertificate() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainLinksAllOfCertificate {\n");
        ...
        {
            return this.Equals(input as DomainLinksAllOfCertificate);
        }

        /// <summary>
        /// Returns true if DomainLinksAllOfCertificate instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainLinksAllOfCertificate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainLinksAllOfCertificate input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TelephonyRequestExecute")]
    
    public partial class TelephonyRequestExecute : IEquatable<TelephonyRequestExecute>
    {
        ...
        {
            return this.Equals(input as TelephonyRequestExecute);
        }

        /// <summary>
        /// Returns true if TelephonyRequestExecute instances are equal
        /// </summary>
        /// <param name="input">Instance of TelephonyRequestExecute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TelephonyRequestExecute input)
        {
            if (input == null)
            {
                return false;

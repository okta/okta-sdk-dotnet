...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Scim_scimServerConfig")]
    
    public partial class ScimScimServerConfig : IEquatable<ScimScimServerConfig>
    {
        ...
        public ScimScimServerConfigPatch Patch { get; set; }

        /// <summary>
        /// Gets or Sets ChangePassword
        /// </summary>
        [DataMember(Name = "changePassword", EmitDefaultValue = true)]
        public ScimScimServerConfigChangePassword ChangePassword { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScimScimServerConfig {\n");
        ...
        {
            return this.Equals(input as ScimScimServerConfig);
        }

        /// <summary>
        /// Returns true if ScimScimServerConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimScimServerConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimScimServerConfig input)
        {
            if (input == null)
            {
                return false;

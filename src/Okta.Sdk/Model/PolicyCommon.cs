...
namespace Okta.Sdk.Model
{
    ...
    /// PolicyCommon
    /// </summary>
    [DataContract(Name = "PolicyCommon")]
    
    public partial class PolicyCommon : IEquatable<PolicyCommon>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyCommon" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PolicyCommon);
        }

        /// <summary>
        /// Returns true if PolicyCommon instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyCommon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyCommon input)
        {
            if (input == null)
            {
                return false;

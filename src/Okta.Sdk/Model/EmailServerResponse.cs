...
namespace Okta.Sdk.Model
{
    ...
    /// EmailServerResponse
    /// </summary>
    [DataContract(Name = "EmailServerResponse")]
    
    public partial class EmailServerResponse : IEquatable<EmailServerResponse>
    {
        ...
        {
            return this.Equals(input as EmailServerResponse);
        }

        /// <summary>
        /// Returns true if EmailServerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailServerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailServerResponse input)
        {
            if (input == null)
            {
                return false;

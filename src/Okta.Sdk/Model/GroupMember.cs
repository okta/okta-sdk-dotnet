...
namespace Okta.Sdk.Model
{
    ...
    public partial class GroupMember : IEquatable<GroupMember>
    {
        ...
        /// The group rule ID
        /// </summary>
        /// <value>The group rule ID</value>
        [DataMember(Name = "groupRuleId", EmitDefaultValue = true)]
        public string GroupRuleId { get; private set; }

        /// <summary>
        /// Returns false as GroupRuleId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeGroupRuleId()
        {
            return false;
        }
        /// <summary>
        ...
        public bool Equals(GroupMember input)
        {
            ...
            return 
                (
                    this.GroupRuleId == input.GroupRuleId ||
                    (this.GroupRuleId != null &&
                    this.GroupRuleId.Equals(input.GroupRuleId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GroupRuleId != null)
                {
                    hashCode = (hashCode * 59) + this.GroupRuleId.GetHashCode();
                }

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoogleApplication")]
    
    public partial class GoogleApplication : IEquatable<GoogleApplication>
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        public sealed class NameEnum : StringEnum
        {
            ...
            public static NameEnum Google = new NameEnum("google");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleApplication" /> class.
        /// </summary>
        ...
        public GoogleApplicationSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GoogleApplication {\n");
        ...
        {
            return this.Equals(input as GoogleApplication);
        }

        /// <summary>
        /// Returns true if GoogleApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of GoogleApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleApplication input)
        {
            if (input == null)
            {
                return false;

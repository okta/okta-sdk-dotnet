...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatorMethodWebAuthn")]
    ...
    public partial class AuthenticatorMethodWebAuthn : AuthenticatorMethodBase, IEquatable<AuthenticatorMethodWebAuthn>
    {
        ...
        public AuthenticatorMethodWebAuthnAllOfSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatorMethodWebAuthn {\n");
        ...
        {
            return this.Equals(input as AuthenticatorMethodWebAuthn);
        }

        /// <summary>
        /// Returns true if AuthenticatorMethodWebAuthn instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatorMethodWebAuthn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatorMethodWebAuthn input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DomainLinks_allOf_brand")]
    
    public partial class DomainLinksAllOfBrand : IEquatable<DomainLinksAllOfBrand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainLinksAllOfBrand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public DomainLinksAllOfBrand() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainLinksAllOfBrand {\n");
        ...
        {
            return this.Equals(input as DomainLinksAllOfBrand);
        }

        /// <summary>
        /// Returns true if DomainLinksAllOfBrand instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainLinksAllOfBrand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainLinksAllOfBrand input)
        {
            if (input == null)
            {
                return false;

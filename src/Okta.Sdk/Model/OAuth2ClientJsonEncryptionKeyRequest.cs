...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OAuth2ClientJsonEncryptionKeyRequest")]
    
    public partial class OAuth2ClientJsonEncryptionKeyRequest : IEquatable<OAuth2ClientJsonEncryptionKeyRequest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OAuth2ClientJsonEncryptionKeyRequest {\n");
        ...
        {
            return this.Equals(input as OAuth2ClientJsonEncryptionKeyRequest);
        }

        /// <summary>
        /// Returns true if OAuth2ClientJsonEncryptionKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuth2ClientJsonEncryptionKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuth2ClientJsonEncryptionKeyRequest input)
        {
            if (input == null)
            {
                return false;

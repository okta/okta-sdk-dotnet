...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthServerLinks_allOf_rotateKey")]
    
    public partial class AuthServerLinksAllOfRotateKey : IEquatable<AuthServerLinksAllOfRotateKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthServerLinksAllOfRotateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AuthServerLinksAllOfRotateKey() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthServerLinksAllOfRotateKey {\n");
        ...
        {
            return this.Equals(input as AuthServerLinksAllOfRotateKey);
        }

        /// <summary>
        /// Returns true if AuthServerLinksAllOfRotateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthServerLinksAllOfRotateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthServerLinksAllOfRotateKey input)
        {
            if (input == null)
            {
                return false;

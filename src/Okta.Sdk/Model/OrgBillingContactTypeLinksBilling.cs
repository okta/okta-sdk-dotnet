...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orgBillingContactType__links_billing")]
    
    public partial class OrgBillingContactTypeLinksBilling : IEquatable<OrgBillingContactTypeLinksBilling>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgBillingContactTypeLinksBilling" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public OrgBillingContactTypeLinksBilling() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrgBillingContactTypeLinksBilling {\n");
        ...
        {
            return this.Equals(input as OrgBillingContactTypeLinksBilling);
        }

        /// <summary>
        /// Returns true if OrgBillingContactTypeLinksBilling instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgBillingContactTypeLinksBilling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgBillingContactTypeLinksBilling input)
        {
            if (input == null)
            {
                return false;

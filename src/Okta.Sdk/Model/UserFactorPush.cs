...
namespace Okta.Sdk.Model
{
    ...
    /// UserFactorPush
    /// </summary>
    [DataContract(Name = "UserFactorPush")]
    ...
    public partial class UserFactorPush : UserFactor, IEquatable<UserFactorPush>
    {
        /// <summary>
        /// Defines Provider
        /// </summary>
        ...
        public UserFactorPushProfile Profile { get; set; }
        ...
        {
            return this.Equals(input as UserFactorPush);
        }

        /// <summary>
        /// Returns true if UserFactorPush instances are equal
        /// </summary>
        /// <param name="input">Instance of UserFactorPush to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFactorPush input)
        {
            if (input == null)
            {
                return false;

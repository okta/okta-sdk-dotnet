...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "token_hardware")]
    
    public partial class TokenHardware : IEquatable<TokenHardware>
    {
        ...
        {
            return this.Equals(input as TokenHardware);
        }

        /// <summary>
        /// Returns true if TokenHardware instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenHardware to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenHardware input)
        {
            if (input == null)
            {
                return false;

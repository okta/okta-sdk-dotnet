...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ZscalerbyzApplication")]
    
    public partial class ZscalerbyzApplication : IEquatable<ZscalerbyzApplication>
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        {
            /// <summary>
            /// StringEnum Zscalerbyz for value: zscalerbyz
            /// </summary>
            
            public static NameEnum Zscalerbyz = new NameEnum("zscalerbyz");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZscalerbyzApplication" /> class.
        /// </summary>
        ...
        public ZscalerbyzApplicationSettings Settings { get; set; }
        ...
        {
            return this.Equals(input as ZscalerbyzApplication);
        }

        /// <summary>
        /// Returns true if ZscalerbyzApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of ZscalerbyzApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZscalerbyzApplication input)
        {
            if (input == null)
            {
                return false;

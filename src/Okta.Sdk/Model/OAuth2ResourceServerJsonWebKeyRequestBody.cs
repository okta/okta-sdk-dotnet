...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OAuth2ResourceServerJsonWebKeyRequestBody")]
    
    public partial class OAuth2ResourceServerJsonWebKeyRequestBody : IEquatable<OAuth2ResourceServerJsonWebKeyRequestBody>
    {
        /// <summary>
        /// Status of the JSON Web Key
        /// </summary>
        /// <value>Status of the JSON Web Key</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OAuth2ResourceServerJsonWebKeyRequestBody {\n");
        ...
        {
            return this.Equals(input as OAuth2ResourceServerJsonWebKeyRequestBody);
        }

        /// <summary>
        /// Returns true if OAuth2ResourceServerJsonWebKeyRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuth2ResourceServerJsonWebKeyRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuth2ResourceServerJsonWebKeyRequestBody input)
        {
            if (input == null)
            {
                return false;

...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Behavior_Detection_Rule_Settings_based_on_Event_History")]
    
    public partial class BehaviorDetectionRuleSettingsBasedOnEventHistory : IEquatable<BehaviorDetectionRuleSettingsBasedOnEventHistory>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BehaviorDetectionRuleSettingsBasedOnEventHistory {\n");
        ...
        {
            return this.Equals(input as BehaviorDetectionRuleSettingsBasedOnEventHistory);
        }

        /// <summary>
        /// Returns true if BehaviorDetectionRuleSettingsBasedOnEventHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of BehaviorDetectionRuleSettingsBasedOnEventHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BehaviorDetectionRuleSettingsBasedOnEventHistory input)
        {
            if (input == null)
            {
                return false;

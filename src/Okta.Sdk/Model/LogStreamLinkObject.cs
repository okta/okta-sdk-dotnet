...
namespace Okta.Sdk.Model
{
    ...
    /// LogStreamLinkObject
    /// </summary>
    [DataContract(Name = "LogStreamLinkObject")]
    
    public partial class LogStreamLinkObject : IEquatable<LogStreamLinkObject>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogStreamLinkObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public LogStreamLinkObject() { }
        ...
        {
            return this.Equals(input as LogStreamLinkObject);
        }

        /// <summary>
        /// Returns true if LogStreamLinkObject instances are equal
        /// </summary>
        /// <param name="input">Instance of LogStreamLinkObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogStreamLinkObject input)
        {
            if (input == null)
            {
                return false;

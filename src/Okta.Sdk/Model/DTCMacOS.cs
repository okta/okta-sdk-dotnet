...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DTCMacOS")]
    
    public partial class DTCMacOS : IEquatable<DTCMacOS>
    {
        ...
        {
            return this.Equals(input as DTCMacOS);
        }

        /// <summary>
        /// Returns true if DTCMacOS instances are equal
        /// </summary>
        /// <param name="input">Instance of DTCMacOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DTCMacOS input)
        {
            if (input == null)
            {
                return false;

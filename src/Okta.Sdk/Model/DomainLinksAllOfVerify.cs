...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DomainLinks_allOf_verify")]
    
    public partial class DomainLinksAllOfVerify : IEquatable<DomainLinksAllOfVerify>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainLinksAllOfVerify" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public DomainLinksAllOfVerify() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainLinksAllOfVerify {\n");
        ...
        {
            return this.Equals(input as DomainLinksAllOfVerify);
        }

        /// <summary>
        /// Returns true if DomainLinksAllOfVerify instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainLinksAllOfVerify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainLinksAllOfVerify input)
        {
            if (input == null)
            {
                return false;

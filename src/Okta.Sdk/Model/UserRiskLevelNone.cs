...
namespace Okta.Sdk.Model
{
    ...
    public partial class UserRiskLevelNone : UserRiskGetResponse, IEquatable<UserRiskLevelNone>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserRiskLevelNone {\n");
        ...
        {
            return this.Equals(input as UserRiskLevelNone);
        }

        /// <summary>
        /// Returns true if UserRiskLevelNone instances are equal
        /// </summary>
        /// <param name="input">Instance of UserRiskLevelNone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserRiskLevelNone input)
        {
            if (input == null)
            {
                return false;

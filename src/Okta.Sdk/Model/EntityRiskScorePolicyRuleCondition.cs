...
namespace Okta.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityRiskScorePolicyRuleCondition")]
    
    public partial class EntityRiskScorePolicyRuleCondition : IEquatable<EntityRiskScorePolicyRuleCondition>
    {
        /// <summary>
        /// Defines Level
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityRiskScorePolicyRuleCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public EntityRiskScorePolicyRuleCondition() { }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityRiskScorePolicyRuleCondition {\n");
        ...
        {
            return this.Equals(input as EntityRiskScorePolicyRuleCondition);
        }

        /// <summary>
        /// Returns true if EntityRiskScorePolicyRuleCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityRiskScorePolicyRuleCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityRiskScorePolicyRuleCondition input)
        {
            if (input == null)
            {
                return false;

...
public class CSharpClientCodegen extends AbstractCSharpCodegen {
    ...
    public CSharpClientCodegen() {
        ...
        modelTemplateFiles.put("model.mustache", fileSuffix);
        modelTemplateFiles.put("IModel.mustache", fileSuffix);
        apiTemplateFiles.put("api.mustache", fileSuffix);
        apiTemplateFiles.put("IApi.mustache", fileSuffix);
    ...
    private String getInternalHttpOperation(String httpMethod){
        String internalOperation = "PostAsync";

        switch (httpMethod.toUpperCase()){
            case "GET":
                internalOperation = "GetAsync";
                break;
            case "DELETE":
                internalOperation = "DeleteAsync";
                break;
            case "PUT":
                internalOperation = "PutAsync";
                break;
        }

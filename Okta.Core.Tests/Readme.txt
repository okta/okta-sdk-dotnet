...
3. In Okta.Core.Tests app.config and change the values for TenantUrl and ApiKey in the <appSettings> section
4. Open the OktaSDKTests.sdf in Server Explorer==>SQLite Toolbox icon and edit the rows in the User and Group tables to your liking